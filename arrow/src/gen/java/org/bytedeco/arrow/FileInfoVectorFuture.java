...
@Name("arrow::Future<std::vector<arrow::fs::FileInfo> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class FileInfoVectorFuture extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FileInfoVectorFuture(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FileInfoVectorFuture(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public FileInfoVectorFuture position(long position) {
        return (FileInfoVectorFuture)super.position(position);
    }
    @Override public FileInfoVectorFuture getPointer(long i) {
        return new FileInfoVectorFuture((Pointer)this).offsetAddress(i);
    }
  ...
  public FileInfoVectorFuture() { super((Pointer)null); allocate(); }
...
// #endif
  ...
  ///
  public native @Const @ByRef FileInfoVectorResult result();
  ...
  public native @ByRef(true) FileInfoVectorResult MoveResult();
  ...
  public native void MarkFinished(@ByVal FileInfoVectorResult res);
  ...
  public static native @ByVal FileInfoVectorFuture Make();

  /** \brief Producer API: instantiate a finished Future */
  public static native @ByVal FileInfoVectorFuture MakeFinished(@ByVal FileInfoVectorResult res);
  ...
  public FileInfoVectorFuture(@ByVal FileInfoVector val) { super((Pointer)null); allocate(val); }
  private native void allocate(@ByVal FileInfoVector val);

  /** \brief Implicit constructor to create a future from a Result, enabling use
   *      of macros like ARROW_ASSIGN_OR_RAISE. */
  public FileInfoVectorFuture(@ByVal FileInfoVectorResult res) { super((Pointer)null); allocate(res); }
  private native void allocate(@ByVal FileInfoVectorResult res);

  /** \brief Implicit constructor to create a future from a Status, enabling use
   *      of macros like ARROW_RETURN_NOT_OK. */
  public FileInfoVectorFuture(@ByVal Status s) { super((Pointer)null); allocate(s); }
