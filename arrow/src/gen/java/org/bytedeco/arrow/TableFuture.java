...
@Name("arrow::Future<std::shared_ptr<arrow::Table> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class TableFuture extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TableFuture(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public TableFuture(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public TableFuture position(long position) {
        return (TableFuture)super.position(position);
    }
    @Override public TableFuture getPointer(long i) {
        return new TableFuture((Pointer)this).offsetAddress(i);
    }
  ...
  public TableFuture() { super((Pointer)null); allocate(); }
...
// #endif
  ...
  ///
  public native @Const @ByRef TableResult result();
  ...
  public native void MarkFinished(@ByVal TableResult res);
  ...
  public static native @ByVal TableFuture Make();

  /** \brief Producer API: instantiate a finished Future */
  public static native @ByVal TableFuture MakeFinished(@ByVal TableResult res);
  ...
  public TableFuture(@SharedPtr @Cast({"", "std::shared_ptr<arrow::Table>"}) Table val) { super((Pointer)null); allocate(val); }
  private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::Table>"}) Table val);

  /** \brief Implicit constructor to create a future from a Result, enabling use
   *      of macros like ARROW_ASSIGN_OR_RAISE. */
  public TableFuture(@ByVal TableResult res) { super((Pointer)null); allocate(res); }
  private native void allocate(@ByVal TableResult res);

  /** \brief Implicit constructor to create a future from a Status, enabling use
   *      of macros like ARROW_RETURN_NOT_OK. */
  public TableFuture(@ByVal Status s) { super((Pointer)null); allocate(s); }
