...
@Name("arrow::Result<std::shared_ptr<arrow::ipc::Message> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class MessageSharedResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public MessageSharedResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public MessageSharedResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public MessageSharedResult getPointer(long i) {
        return new MessageSharedResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public MessageSharedResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public MessageSharedResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public MessageSharedResult(@SharedPtr @Cast({"", "std::shared_ptr<arrow::ipc::Message>"}) Message value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::ipc::Message>"}) Message value);
  ...
  ///
  ///
  public MessageSharedResult(@Const @ByRef MessageSharedResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef MessageSharedResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) MessageSharedResult put(@Const @ByRef MessageSharedResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef MessageSharedResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef Message ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") Message multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") Message access();
  ...
  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::ipc::Message>"}) Message ValueUnsafe();

  

  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::ipc::Message>"}) Message MoveValueUnsafe();
}
