...
@Name("arrow::Result<std::unique_ptr<arrow::RecordBatchBuilder> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class RecordBatchBuilderUniqueResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public RecordBatchBuilderUniqueResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public RecordBatchBuilderUniqueResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public RecordBatchBuilderUniqueResult position(long position) {
        return (RecordBatchBuilderUniqueResult)super.position(position);
    }
    @Override public RecordBatchBuilderUniqueResult getPointer(long i) {
        return new RecordBatchBuilderUniqueResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public RecordBatchBuilderUniqueResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public RecordBatchBuilderUniqueResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public RecordBatchBuilderUniqueResult(@UniquePtr RecordBatchBuilder value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@UniquePtr RecordBatchBuilder value);
  ...
  ///
  ///
  public RecordBatchBuilderUniqueResult(@Const @ByRef RecordBatchBuilderUniqueResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef RecordBatchBuilderUniqueResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) RecordBatchBuilderUniqueResult put(@Const @ByRef RecordBatchBuilderUniqueResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef RecordBatchBuilderUniqueResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @UniquePtr RecordBatchBuilder ValueOrDie();
  public native @UniquePtr @Name("operator *") RecordBatchBuilder multiply();
  
  ///
  ///
  public native @UniquePtr @Name("operator ->") RecordBatchBuilder access();
  ...
  public native @UniquePtr RecordBatchBuilder ValueUnsafe();

  

  public native @UniquePtr RecordBatchBuilder MoveValueUnsafe();
}
