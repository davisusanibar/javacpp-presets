...
@Name("arrow::Result<std::shared_ptr<arrow::io::BufferedOutputStream> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class BufferedOutputStreamResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public BufferedOutputStreamResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public BufferedOutputStreamResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public BufferedOutputStreamResult position(long position) {
        return (BufferedOutputStreamResult)super.position(position);
    }
    @Override public BufferedOutputStreamResult getPointer(long i) {
        return new BufferedOutputStreamResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public BufferedOutputStreamResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public BufferedOutputStreamResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public BufferedOutputStreamResult(@SharedPtr BufferedOutputStream value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr BufferedOutputStream value);
  ...
  ///
  ///
  public BufferedOutputStreamResult(@Const @ByRef BufferedOutputStreamResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef BufferedOutputStreamResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) BufferedOutputStreamResult put(@Const @ByRef BufferedOutputStreamResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef BufferedOutputStreamResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr BufferedOutputStream ValueOrDie();
  public native @SharedPtr @Name("operator *") BufferedOutputStream multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") BufferedOutputStream access();
  ...
  public native @SharedPtr BufferedOutputStream MoveValueUnsafe();
}
