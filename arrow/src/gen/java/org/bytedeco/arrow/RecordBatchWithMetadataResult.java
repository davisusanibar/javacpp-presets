...
@Name("arrow::Result<arrow::RecordBatchWithMetadata>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class RecordBatchWithMetadataResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public RecordBatchWithMetadataResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public RecordBatchWithMetadataResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public RecordBatchWithMetadataResult position(long position) {
        return (RecordBatchWithMetadataResult)super.position(position);
    }
    @Override public RecordBatchWithMetadataResult getPointer(long i) {
        return new RecordBatchWithMetadataResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public RecordBatchWithMetadataResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public RecordBatchWithMetadataResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public RecordBatchWithMetadataResult(@ByRef(true) RecordBatchWithMetadata value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@ByRef(true) RecordBatchWithMetadata value);
  ...
  ///
  ///
  public RecordBatchWithMetadataResult(@Const @ByRef RecordBatchWithMetadataResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef RecordBatchWithMetadataResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) RecordBatchWithMetadataResult put(@Const @ByRef RecordBatchWithMetadataResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef RecordBatchWithMetadataResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef RecordBatchWithMetadata ValueOrDie();
  public native @ByRef @Name("operator *") RecordBatchWithMetadata multiply();
  
  ///
  ///
  public native @Name("operator ->") RecordBatchWithMetadata access();
  ...
  public native @Const @ByRef RecordBatchWithMetadata ValueUnsafe();

  

  public native @ByVal RecordBatchWithMetadata MoveValueUnsafe();
}
