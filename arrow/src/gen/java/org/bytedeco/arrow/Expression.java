...
public class Expression extends Pointer {
  ...
  public static class Call extends Pointer {
    ...
    public native @ByRef TypeHolder type(); public native Call type(TypeHolder setter);
  ...
  public native @ByVal ExpressionResult Bind(@Const @ByRef TypeHolder in, ExecContext arg1/*=nullptr*/);
  public native @ByVal ExpressionResult Bind(@Const @ByRef TypeHolder in);
  ...
  public static class Parameter extends Pointer {
    ...
    // post-bind properties
    public native @ByRef TypeHolder type(); public native Parameter type(TypeHolder setter);
