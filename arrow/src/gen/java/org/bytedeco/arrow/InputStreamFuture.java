...
@Name("arrow::Future<std::shared_ptr<arrow::io::InputStream> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class InputStreamFuture extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public InputStreamFuture(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public InputStreamFuture(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public InputStreamFuture position(long position) {
        return (InputStreamFuture)super.position(position);
    }
    @Override public InputStreamFuture getPointer(long i) {
        return new InputStreamFuture((Pointer)this).offsetAddress(i);
    }
  ...
  public InputStreamFuture() { super((Pointer)null); allocate(); }
...
// #endif
  ...
  ///
  public native @Const @ByRef InputStreamResult result();
  ...
  public native @ByRef(true) InputStreamResult MoveResult();
  ...
  public native void MarkFinished(@ByVal InputStreamResult res);
  ...
  public static native @ByVal InputStreamFuture Make();

  /** \brief Producer API: instantiate a finished Future */
  public static native @ByVal InputStreamFuture MakeFinished(@ByVal InputStreamResult res);
  ...
  public InputStreamFuture(@SharedPtr @Cast({"", "std::shared_ptr<arrow::io::InputStream>"}) InputStream val) { super((Pointer)null); allocate(val); }
  private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::io::InputStream>"}) InputStream val);

  /** \brief Implicit constructor to create a future from a Result, enabling use
   *      of macros like ARROW_ASSIGN_OR_RAISE. */
  public InputStreamFuture(@ByVal InputStreamResult res) { super((Pointer)null); allocate(res); }
  private native void allocate(@ByVal InputStreamResult res);

  /** \brief Implicit constructor to create a future from a Status, enabling use
   *      of macros like ARROW_RETURN_NOT_OK. */
  public InputStreamFuture(@ByVal Status s) { super((Pointer)null); allocate(s); }
