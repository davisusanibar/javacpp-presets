...
@Name("arrow::Result<std::shared_ptr<arrow::io::ReadableFile> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class ReadableFileResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ReadableFileResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ReadableFileResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public ReadableFileResult getPointer(long i) {
        return new ReadableFileResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public ReadableFileResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ReadableFileResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public ReadableFileResult(@SharedPtr ReadableFile value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr ReadableFile value);
  ...
  ///
  ///
  public ReadableFileResult(@Const @ByRef ReadableFileResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef ReadableFileResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) ReadableFileResult put(@Const @ByRef ReadableFileResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef ReadableFileResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr ReadableFile ValueOrDie();
  public native @SharedPtr @Name("operator *") ReadableFile multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") ReadableFile access();
  ...
  public native @SharedPtr ReadableFile ValueUnsafe();

  

  public native @SharedPtr ReadableFile MoveValueUnsafe();
}
