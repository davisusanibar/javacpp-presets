...
public class IpcPayload extends Pointer {
  ...
  public native @Cast("int64_t") long body_length(); public native IpcPayload body_length(long setter);      // serialized body length (padded, maybe compressed)
  public native @Cast("int64_t") long raw_body_length(); public native IpcPayload raw_body_length(long setter);  // initial uncompressed body length
}
