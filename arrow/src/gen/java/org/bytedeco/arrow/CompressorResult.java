...
@Name("arrow::Result<std::shared_ptr<arrow::util::Compressor> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class CompressorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public CompressorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public CompressorResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public CompressorResult position(long position) {
        return (CompressorResult)super.position(position);
    }
    @Override public CompressorResult getPointer(long i) {
        return new CompressorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public CompressorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public CompressorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public CompressorResult(@SharedPtr Compressor value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr Compressor value);
  ...
  ///
  ///
  public CompressorResult(@Const @ByRef CompressorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef CompressorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) CompressorResult put(@Const @ByRef CompressorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef CompressorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr Compressor ValueOrDie();
  public native @SharedPtr @Name("operator *") Compressor multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") Compressor access();
  ...
  public native @SharedPtr Compressor ValueUnsafe();

  

  public native @SharedPtr Compressor MoveValueUnsafe();
}
