...
@Name("arrow::Result<std::shared_ptr<arrow::compute::SelectionVector> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class SelectionVectorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public SelectionVectorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public SelectionVectorResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public SelectionVectorResult position(long position) {
        return (SelectionVectorResult)super.position(position);
    }
    @Override public SelectionVectorResult getPointer(long i) {
        return new SelectionVectorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public SelectionVectorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public SelectionVectorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@SharedPtr @ByRef(true) SelectionVector value);
  ...
  ///
  ///
  public SelectionVectorResult(@Const @ByRef SelectionVectorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef SelectionVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) SelectionVectorResult put(@Const @ByRef SelectionVectorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef SelectionVectorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef SelectionVector ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") SelectionVector multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") SelectionVector access();
  ...
  public native @Const @SharedPtr @ByRef SelectionVector ValueUnsafe();

  

  public native @SharedPtr @ByVal SelectionVector MoveValueUnsafe();
}
