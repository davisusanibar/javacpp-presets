...
public class NullBuilder extends ArrayBuilder {
  ...
  public NullBuilder(MemoryPool pool/*=arrow::default_memory_pool()*/,
                         @Cast("int64_t") long alignment/*=arrow::kDefaultBufferAlignment*/) { super((Pointer)null); allocate(pool, alignment); }
  ...
  public native @ByVal Status AppendArraySlice(@Const @ByRef ArraySpan arg0, @Cast("int64_t") long arg1, @Cast("int64_t") long length);
