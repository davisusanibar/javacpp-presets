...
public class Decimal256 extends BasicDecimal256 {
  ...
  public static native @ByVal Status FromString(@Const @ByRef @StdString String s, Decimal256 out, IntPointer precision,
                             IntPointer scale/*=nullptr*/);
  public static native @ByVal Status FromString(@Const @ByRef @StdString String s, Decimal256 out, IntPointer precision);
  public static native @ByVal Status FromString(@Const @ByRef @StdString String s, Decimal256 out, IntBuffer precision,
                             IntBuffer scale/*=nullptr*/);
  public static native @ByVal Status FromString(@Const @ByRef @StdString String s, Decimal256 out, IntBuffer precision);
  public static native @ByVal Status FromString(@Const @ByRef @StdString String s, Decimal256 out, int[] precision,
                             int[] scale/*=nullptr*/);
  public static native @ByVal Status FromString(@Const @ByRef @StdString String s, Decimal256 out, int[] precision);
  ...
  public static native @ByVal Status FromString(@StdString BytePointer s, Decimal256 out, int[] precision,
                             int[] scale/*=nullptr*/);
  public static native @ByVal Status FromString(@StdString BytePointer s, Decimal256 out, int[] precision);
  public static native @ByVal Decimal256Result FromString(@Const @ByRef @StdString String s);
