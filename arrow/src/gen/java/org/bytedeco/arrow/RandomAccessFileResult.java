...
@Name("arrow::Result<std::shared_ptr<arrow::io::RandomAccessFile> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class RandomAccessFileResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public RandomAccessFileResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public RandomAccessFileResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public RandomAccessFileResult getPointer(long i) {
        return new RandomAccessFileResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public RandomAccessFileResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public RandomAccessFileResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public RandomAccessFileResult(@SharedPtr @Cast({"", "std::shared_ptr<arrow::io::RandomAccessFile>"}) RandomAccessFile value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::io::RandomAccessFile>"}) RandomAccessFile value);
  ...
  ///
  ///
  public RandomAccessFileResult(@Const @ByRef RandomAccessFileResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef RandomAccessFileResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) RandomAccessFileResult put(@Const @ByRef RandomAccessFileResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef RandomAccessFileResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef RandomAccessFile ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") RandomAccessFile multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") RandomAccessFile access();
  ...
  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::io::RandomAccessFile>"}) RandomAccessFile ValueUnsafe();

  

  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::io::RandomAccessFile>"}) RandomAccessFile MoveValueUnsafe();
}
