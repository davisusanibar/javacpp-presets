...
@Name("arrow::Result<std::vector<arrow::fs::FileInfo> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class FileInfoVectorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FileInfoVectorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FileInfoVectorResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public FileInfoVectorResult getPointer(long i) {
        return new FileInfoVectorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public FileInfoVectorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public FileInfoVectorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) FileInfoVector value);
  ...
  ///
  ///
  public FileInfoVectorResult(@Const @ByRef FileInfoVectorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef FileInfoVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) FileInfoVectorResult put(@Const @ByRef FileInfoVectorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef FileInfoVectorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef FileInfoVector ValueOrDie();
  public native @ByRef @Name("operator *") FileInfoVector multiply();
  
  ///
  ///
  public native @Name("operator ->") FileInfoVector access();
  ...
  public native @Const @ByRef FileInfoVector ValueUnsafe();

  

  public native @ByVal FileInfoVector MoveValueUnsafe();
}
