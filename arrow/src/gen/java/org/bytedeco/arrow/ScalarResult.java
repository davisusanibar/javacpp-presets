...
@Name("arrow::Result<std::shared_ptr<arrow::Scalar> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class ScalarResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ScalarResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ScalarResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public ScalarResult getPointer(long i) {
        return new ScalarResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public ScalarResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ScalarResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public ScalarResult(@SharedPtr @Cast({"", "std::shared_ptr<arrow::Scalar>"}) Scalar value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::Scalar>"}) Scalar value);
  ...
  ///
  ///
  public ScalarResult(@Const @ByRef ScalarResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef ScalarResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) ScalarResult put(@Const @ByRef ScalarResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef ScalarResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef Scalar ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") Scalar multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") Scalar access();
  ...
  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::Scalar>"}) Scalar ValueUnsafe();

  

  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::Scalar>"}) Scalar MoveValueUnsafe();
}
