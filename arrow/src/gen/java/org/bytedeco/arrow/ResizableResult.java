...
@Name("arrow::Result<std::shared_ptr<arrow::ResizableBuffer> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class ResizableResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ResizableResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ResizableResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ResizableResult position(long position) {
        return (ResizableResult)super.position(position);
    }
    @Override public ResizableResult getPointer(long i) {
        return new ResizableResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public ResizableResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ResizableResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@SharedPtr @ByRef(true) ResizableBuffer value);
  ...
  ///
  ///
  public ResizableResult(@Const @ByRef ResizableResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef ResizableResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) ResizableResult put(@Const @ByRef ResizableResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef ResizableResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef ResizableBuffer ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") ResizableBuffer multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") ResizableBuffer access();
  ...
  public native @Const @SharedPtr @ByRef ResizableBuffer ValueUnsafe();

  

  public native @SharedPtr @ByVal ResizableBuffer MoveValueUnsafe();
}
