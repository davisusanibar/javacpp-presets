...
// Targeting ../ArraySpanArrayDataMap.java


// Parsed from arrow/engine/substrait/util.h
 ...
 *                       {@code registry} maps from Substrait function IDs to "names". These
 *                       names will be provided to {@code func_registry} to get the actual
 *                       kernel.
...
@Namespace("arrow::engine") public static native @ByVal RecordBatchReaderSharedResult ExecuteSerializedPlan(
    @Const @ByRef ArrowBuffer substrait_buffer, @Const ExtensionIdRegistry registry/*=NULLPTR*/,
    FunctionRegistry func_registry/*=NULLPTR*/,
    @Const @ByRef(nullValue = "ConversionOptions{}") ConversionOptions conversion_options, @Cast("bool") boolean use_threads/*=true*/,
    MemoryPool memory_pool/*=default_memory_pool()*/);
@Namespace("arrow::engine") public static native @ByVal RecordBatchReaderSharedResult ExecuteSerializedPlan(
    @Const @ByRef ArrowBuffer substrait_buffer);

/** \brief Get a Serialized Plan from a Substrait JSON plan.
 *  This is a helper method for Python tests. */
@Namespace("arrow::engine") public static native @ByVal BufferResult SerializeJsonPlan(
    @StdString String substrait_json);
@Namespace("arrow::engine") public static native @ByVal BufferResult SerializeJsonPlan(
    @StdString BytePointer substrait_json);
...
@Namespace("arrow::engine") public static native @SharedPtr ExtensionIdRegistry MakeExtensionIdRegistry();

@Namespace("arrow::engine") public static native @StdString String default_extension_types_uri();
...
// Parsed from arrow/engine/substrait/type_fwd.h
...
// #pragma once
// Targeting ../ExtensionIdRegistry.java


// Targeting ../ExtensionSet.java


// Targeting ../ConversionOptions.java


// Targeting ../DeclarationInfo.java
...
public static final int ARROW_VERSION_MAJOR = 11;
...
public static final String ARROW_VERSION_STRING = "11.0.0";

public static final String ARROW_SO_VERSION = "1100";
public static final String ARROW_FULL_SO_VERSION = "1100.0.0";

public static final String ARROW_CXX_COMPILER_ID = "Clang";
public static final String ARROW_CXX_COMPILER_VERSION = "11.1.0";
public static final String ARROW_CXX_COMPILER_FLAGS = " -Qunused-arguments -fcolor-diagnostics -O3 -DNDEBUG";

public static final String ARROW_GIT_ID = "1ca5630ffa2c17502c2c1312c6ab779bf7dd50ae";
public static final String ARROW_GIT_DESCRIPTION = "1.5.8-25-g1ca5630ffa-dirty";
...
@Namespace("arrow::bit_util") @MemberGetter public static native @Cast("const uint8_t") byte kBytePopcount(int i);
@Namespace("arrow::bit_util") @MemberGetter public static native @Cast("const uint8_t*") BytePointer kBytePopcount();

@Namespace("arrow::bit_util") public static native @Cast("uint64_t") long PopCount(@Cast("uint64_t") long bitmap);
@Namespace("arrow::bit_util") public static native @Cast("uint32_t") int PopCount(@Cast("uint32_t") int bitmap);
...
@Namespace("arrow::bit_util") public static native @Cast("const int64_t") long CeilDiv(@Cast("int64_t") long value, @Cast("int64_t") long divisor);

// Return the number of bytes needed to fit the given number of bits
@Namespace("arrow::bit_util") public static native @Cast("const int64_t") long BytesForBits(@Cast("int64_t") long bits);

@Namespace("arrow::bit_util") public static native @Cast("const bool") boolean IsPowerOf2(@Cast("int64_t") long value);

// Returns the smallest power of two that contains v.  If v is already a
// power of two, it is returned as is.
@Namespace("arrow::bit_util") public static native @Cast("int64_t") long NextPower2(@Cast("int64_t") long n);

@Namespace("arrow::bit_util") public static native @Cast("const bool") boolean IsMultipleOf64(@Cast("int64_t") long n);

@Namespace("arrow::bit_util") public static native @Cast("const bool") boolean IsMultipleOf8(@Cast("int64_t") long n);

// Returns a mask for the bit_index lower order bits.
// Only valid for bit_index in the range [0, 64).
@Namespace("arrow::bit_util") public static native @Cast("const uint64_t") long LeastSignificantBitMask(@Cast("int64_t") long bit_index);

// Returns 'value' rounded up to the nearest multiple of 'factor'
@Namespace("arrow::bit_util") public static native @Cast("const int64_t") long RoundUp(@Cast("int64_t") long value, @Cast("int64_t") long factor);

// Returns 'value' rounded down to the nearest multiple of 'factor'
@Namespace("arrow::bit_util") public static native @Cast("const int64_t") long RoundDown(@Cast("int64_t") long value, @Cast("int64_t") long factor);
...
@Namespace("arrow::bit_util") public static native @Cast("const int64_t") long RoundUpToPowerOf2(@Cast("int64_t") long value, @Cast("int64_t") long factor);

@Namespace("arrow::bit_util") public static native @Cast("const int64_t") long RoundUpToMultipleOf8(@Cast("int64_t") long num);

@Namespace("arrow::bit_util") public static native @Cast("const int64_t") long RoundUpToMultipleOf64(@Cast("int64_t") long num);
...
@Namespace("arrow::bit_util") public static native @Cast("const int64_t") long CoveringBytes(@Cast("int64_t") long offset, @Cast("int64_t") long length);

// Returns the 'num_bits' least-significant bits of 'v'.
@Namespace("arrow::bit_util") public static native @Cast("uint64_t") long TrailingBits(@Cast("uint64_t") long v, int num_bits);

/** \brief Count the number of leading zeros in an unsigned integer. */
@Namespace("arrow::bit_util") public static native int CountLeadingZeros(@Cast("uint32_t") int value);

@Namespace("arrow::bit_util") public static native int CountLeadingZeros(@Cast("uint64_t") long value);

@Namespace("arrow::bit_util") public static native int CountTrailingZeros(@Cast("uint32_t") int value);

@Namespace("arrow::bit_util") public static native int CountTrailingZeros(@Cast("uint64_t") long value);

// Returns the minimum number of bits needed to represent an unsigned value
@Namespace("arrow::bit_util") public static native int NumRequiredBits(@Cast("uint64_t") long x);

// Returns ceil(log2(x)).
@Namespace("arrow::bit_util") public static native int Log2(@Cast("uint64_t") long x);
...
@Namespace("arrow::bit_util") @MemberGetter public static native @Cast("const uint8_t") byte kBitmask(int i);
@Namespace("arrow::bit_util") @MemberGetter public static native @Cast("const uint8_t*") BytePointer kBitmask();

// the bitwise complement version of kBitmask
@Namespace("arrow::bit_util") @MemberGetter public static native @Cast("const uint8_t") byte kFlippedBitmask(int i);
@Namespace("arrow::bit_util") @MemberGetter public static native @Cast("const uint8_t*") BytePointer kFlippedBitmask();

// Bitmask selecting the (k - 1) preceding bits in a byte
@Namespace("arrow::bit_util") @MemberGetter public static native @Cast("const uint8_t") byte kPrecedingBitmask(int i);
@Namespace("arrow::bit_util") @MemberGetter public static native @Cast("const uint8_t*") BytePointer kPrecedingBitmask();
@Namespace("arrow::bit_util") @MemberGetter public static native @Cast("const uint8_t") byte kPrecedingWrappingBitmask(int i);
@Namespace("arrow::bit_util") @MemberGetter public static native @Cast("const uint8_t*") BytePointer kPrecedingWrappingBitmask();

// the bitwise complement version of kPrecedingBitmask
@Namespace("arrow::bit_util") @MemberGetter public static native @Cast("const uint8_t") byte kTrailingBitmask(int i);
@Namespace("arrow::bit_util") @MemberGetter public static native @Cast("const uint8_t*") BytePointer kTrailingBitmask();

@Namespace("arrow::bit_util") public static native @Cast("const bool") boolean GetBit(@Cast("const uint8_t*") BytePointer bits, @Cast("uint64_t") long i);
@Namespace("arrow::bit_util") public static native @Cast("const bool") boolean GetBit(@Cast("const uint8_t*") ByteBuffer bits, @Cast("uint64_t") long i);
@Namespace("arrow::bit_util") public static native @Cast("const bool") boolean GetBit(@Cast("const uint8_t*") byte[] bits, @Cast("uint64_t") long i);

// Gets the i-th bit from a byte. Should only be used with i <= 7.
@Namespace("arrow::bit_util") public static native @Cast("const bool") boolean GetBitFromByte(@Cast("uint8_t") byte _byte, @Cast("uint8_t") byte i);

@Namespace("arrow::bit_util") public static native void ClearBit(@Cast("uint8_t*") BytePointer bits, @Cast("int64_t") long i);
@Namespace("arrow::bit_util") public static native void ClearBit(@Cast("uint8_t*") ByteBuffer bits, @Cast("int64_t") long i);
@Namespace("arrow::bit_util") public static native void ClearBit(@Cast("uint8_t*") byte[] bits, @Cast("int64_t") long i);

@Namespace("arrow::bit_util") public static native void SetBit(@Cast("uint8_t*") BytePointer bits, @Cast("int64_t") long i);
@Namespace("arrow::bit_util") public static native void SetBit(@Cast("uint8_t*") ByteBuffer bits, @Cast("int64_t") long i);
@Namespace("arrow::bit_util") public static native void SetBit(@Cast("uint8_t*") byte[] bits, @Cast("int64_t") long i);

@Namespace("arrow::bit_util") public static native void SetBitTo(@Cast("uint8_t*") BytePointer bits, @Cast("int64_t") long i, @Cast("bool") boolean bit_is_set);
@Namespace("arrow::bit_util") public static native void SetBitTo(@Cast("uint8_t*") ByteBuffer bits, @Cast("int64_t") long i, @Cast("bool") boolean bit_is_set);
@Namespace("arrow::bit_util") public static native void SetBitTo(@Cast("uint8_t*") byte[] bits, @Cast("int64_t") long i, @Cast("bool") boolean bit_is_set);

/** \brief set or clear a range of bits quickly */
@Namespace("arrow::bit_util") public static native void SetBitsTo(@Cast("uint8_t*") BytePointer bits, @Cast("int64_t") long start_offset, @Cast("int64_t") long length, @Cast("bool") boolean bits_are_set);
@Namespace("arrow::bit_util") public static native void SetBitsTo(@Cast("uint8_t*") ByteBuffer bits, @Cast("int64_t") long start_offset, @Cast("int64_t") long length, @Cast("bool") boolean bits_are_set);
@Namespace("arrow::bit_util") public static native void SetBitsTo(@Cast("uint8_t*") byte[] bits, @Cast("int64_t") long start_offset, @Cast("int64_t") long length, @Cast("bool") boolean bits_are_set);

/** \brief Sets all bits in the bitmap to true */
@Namespace("arrow::bit_util") public static native void SetBitmap(@Cast("uint8_t*") BytePointer data, @Cast("int64_t") long offset, @Cast("int64_t") long length);
@Namespace("arrow::bit_util") public static native void SetBitmap(@Cast("uint8_t*") ByteBuffer data, @Cast("int64_t") long offset, @Cast("int64_t") long length);
@Namespace("arrow::bit_util") public static native void SetBitmap(@Cast("uint8_t*") byte[] data, @Cast("int64_t") long offset, @Cast("int64_t") long length);

/** \brief Clears all bits in the bitmap (set to false) */
@Namespace("arrow::bit_util") public static native void ClearBitmap(@Cast("uint8_t*") BytePointer data, @Cast("int64_t") long offset, @Cast("int64_t") long length);
@Namespace("arrow::bit_util") public static native void ClearBitmap(@Cast("uint8_t*") ByteBuffer data, @Cast("int64_t") long offset, @Cast("int64_t") long length);
@Namespace("arrow::bit_util") public static native void ClearBitmap(@Cast("uint8_t*") byte[] data, @Cast("int64_t") long offset, @Cast("int64_t") long length);
...
@Namespace("arrow") public static native @SharedPtr KeyValueMetadata key_value_metadata(
    @Const @ByRef StringStringMap pairs);
...
@Namespace("arrow") public static native @SharedPtr KeyValueMetadata key_value_metadata(
    @ByVal StringVector keys, @ByVal StringVector values);
...
// Parsed from arrow/util/string.h
...
@Namespace("arrow") public static native @StdString String HexEncode(@Cast("const uint8_t*") BytePointer data, @Cast("size_t") long length);
@Namespace("arrow") public static native @StdString BytePointer HexEncode(@Cast("const uint8_t*") ByteBuffer data, @Cast("size_t") long length);
@Namespace("arrow") public static native @StdString String HexEncode(@Cast("const uint8_t*") byte[] data, @Cast("size_t") long length);

@Namespace("arrow") public static native @StdString String Escape(String data, @Cast("size_t") long length);
@Namespace("arrow") public static native @StdString BytePointer Escape(@Cast("const char*") BytePointer data, @Cast("size_t") long length);

@Namespace("arrow") public static native @StdString String HexEncode(String data, @Cast("size_t") long length);

@Namespace("arrow") public static native @StdString String HexEncode(@ByVal @StdString String str);

@Namespace("arrow") public static native @StdString String Escape(@ByVal @StdString String str);

@Namespace("arrow") public static native @ByVal Status ParseHexValue(String data, @Cast("uint8_t*") BytePointer out);
@Namespace("arrow") public static native @ByVal Status ParseHexValue(@Cast("const char*") BytePointer data, @Cast("uint8_t*") ByteBuffer out);
@Namespace("arrow") public static native @ByVal Status ParseHexValue(String data, @Cast("uint8_t*") byte[] out);
@Namespace("arrow") public static native @ByVal Status ParseHexValue(@Cast("const char*") BytePointer data, @Cast("uint8_t*") BytePointer out);
@Namespace("arrow") public static native @ByVal Status ParseHexValue(String data, @Cast("uint8_t*") ByteBuffer out);
@Namespace("arrow") public static native @ByVal Status ParseHexValue(@Cast("const char*") BytePointer data, @Cast("uint8_t*") byte[] out);

/** Like std::string_view::starts_with in C++20 */
@Namespace("arrow::internal") public static native @Cast("bool") boolean StartsWith(@ByVal @StdString String s, @ByVal @StdString String prefix);

/** Like std::string_view::ends_with in C++20 */
@Namespace("arrow::internal") public static native @Cast("bool") boolean EndsWith(@ByVal @StdString String s, @ByVal @StdString String suffix);

/** \brief Split a string with a delimiter */
@Namespace("arrow::internal") public static native @StdVector @StdString String SplitString(@ByVal @StdString String v, @Cast("char") byte delim,
                                          @Cast("int64_t") long _limit/*=0*/);
@Namespace("arrow::internal") public static native @StdVector @StdString String SplitString(@ByVal @StdString String v, @Cast("char") byte delim);

/** \brief Join strings with a delimiter */
@Namespace("arrow::internal") public static native @StdString String JoinStrings(@StdVector @StdString String strings,
                        @ByVal @StdString String delimiter);

/** \brief Join strings with a delimiter */
@Namespace("arrow::internal") public static native @StdString String JoinStrings(@Const @ByRef StringVector strings,
                        @ByVal @StdString String delimiter);

/** \brief Trim whitespace from left and right sides of string */
@Namespace("arrow::internal") public static native @StdString String TrimString(@StdString String value);
@Namespace("arrow::internal") public static native @StdString BytePointer TrimString(@StdString BytePointer value);

@Namespace("arrow::internal") public static native @Cast("bool") boolean AsciiEqualsCaseInsensitive(@ByVal @StdString String left, @ByVal @StdString String right);

@Namespace("arrow::internal") public static native @StdString String AsciiToLower(@ByVal @StdString String value);

@Namespace("arrow::internal") public static native @StdString String AsciiToUpper(@ByVal @StdString String value);

/** \brief Search for the first instance of a token and replace it or return nullopt if
 *  the token is not found. */

///
@Namespace("arrow::internal") public static native @StdString @Optional @Cast({"char*", "std::string*"}) BytePointer Replace(@ByVal @StdString String s, @ByVal @StdString String token,
                                   @ByVal @StdString String replacement);
...
@Namespace("arrow::internal") public static native @ByVal BoolResult ParseBoolean(@ByVal @StdString String value);
...
/** \brief Given {@code expr} and {@code warn_msg}; log {@code warn_msg} if {@code expr} is a non-ok status */
 ...
 *  available stats. */
@Namespace("arrow") public static native @ByVal LongResult jemalloc_get_stat(String name);
@Namespace("arrow") public static native @ByVal LongResult jemalloc_get_stat(@Cast("const char*") BytePointer name);
...
@Namespace("arrow") public static native @ByVal Status jemalloc_peak_reset();
 ...
 *  available opt flags. */
@Namespace("arrow") public static native @ByVal Status jemalloc_stats_print(String opts/*=""*/);
@Namespace("arrow") public static native @ByVal Status jemalloc_stats_print();
@Namespace("arrow") public static native @ByVal Status jemalloc_stats_print(@Cast("const char*") BytePointer opts/*=""*/);

/** \brief Print summary statistics in human-readable form using a callback
 *  See malloc_stats_print documentation in jemalloc project documentation for
 *  available opt flags. */
@Namespace("arrow") public static native @ByVal Status jemalloc_stats_print(@ByVal Writer write_cb,
                            String opts/*=""*/);
@Namespace("arrow") public static native @ByVal Status jemalloc_stats_print(@ByVal Writer write_cb);
@Namespace("arrow") public static native @ByVal Status jemalloc_stats_print(@ByVal Writer write_cb,
                            @Cast("const char*") BytePointer opts/*=""*/);
...
///
@Namespace("arrow") public static native @ByVal StringResult jemalloc_stats_string(String opts/*=""*/);
@Namespace("arrow") public static native @ByVal StringResult jemalloc_stats_string();
@Namespace("arrow") public static native @ByVal StringResult jemalloc_stats_string(@Cast("const char*") BytePointer opts/*=""*/);
...
///
@Namespace("arrow") public static native @ByVal BufferUniqueResult AllocateBuffer(@Cast("const int64_t") long size, @Cast("int64_t") long alignment,
                                               MemoryPool pool/*=nullptr*/);
@Namespace("arrow") public static native @ByVal BufferUniqueResult AllocateBuffer(@Cast("const int64_t") long size, @Cast("int64_t") long alignment);
...
///
@Namespace("arrow") public static native @ByVal ResizableUniqueResult AllocateResizableBuffer(
    @Cast("const int64_t") long size, @Cast("const int64_t") long alignment, MemoryPool pool/*=nullptr*/);
@Namespace("arrow") public static native @ByVal ResizableUniqueResult AllocateResizableBuffer(
    @Cast("const int64_t") long size, @Cast("const int64_t") long alignment);
...
///
@Namespace("arrow") public static native @ByVal BufferResult AllocateEmptyBitmap(@Cast("int64_t") long length, @Cast("int64_t") long alignment,
                                                    MemoryPool pool/*=nullptr*/);
@Namespace("arrow") public static native @ByVal BufferResult AllocateEmptyBitmap(@Cast("int64_t") long length, @Cast("int64_t") long alignment);
 ...
 *  @param right [in] a Scalar
 *  @param options [in] comparison options */
@Namespace("arrow") public static native @Cast("bool") boolean ScalarApproxEquals(
    @Const @ByRef Scalar left, @Const @ByRef Scalar right,
    @Const @ByRef(nullValue = "arrow::EqualOptions::Defaults()") EqualOptions options);
@Namespace("arrow") public static native @Cast("bool") boolean ScalarApproxEquals(
    @Const @ByRef Scalar left, @Const @ByRef Scalar right);
...
// Targeting ../TypeHolderResult.java


// Targeting ../TimestampScalarResult.java


// Targeting ../RecordBatchWithMetadataResult.java


// Targeting ../ArrayBuilderUniqueResult.java


// Targeting ../FunctionExecutorResult.java


// Targeting ../StructTypeResult.java


// Targeting ../RecordBatchBuilderUniqueResult.java


// Targeting ../FutureResult.java
...
///
@Namespace("arrow") public static native @Cast("arrow::Type::type*") @StdVector IntPointer AllTypeIds();
...
@Namespace("arrow") public static native @SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType struct_(
...
/** \brief Create a SparseUnionType instance */
@Namespace("arrow") public static native @SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType sparse_union(
    @Const @ByRef ArrayVector children, @ByVal(nullValue = "std::vector<std::string>{}") StringVector field_names,
    @StdVector BytePointer type_codes/*={}*/);
@Namespace("arrow") public static native @SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType sparse_union(
...
@Namespace("arrow") public static native @SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType dense_union(@ByVal FieldVector child_fields,
                                                   @StdVector byte[] type_codes/*={}*/);
/** \brief Create a DenseUnionType instance */
@Namespace("arrow") public static native @SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType dense_union(
    @Const @ByRef ArrayVector children, @ByVal(nullValue = "std::vector<std::string>{}") StringVector field_names,
    @StdVector BytePointer type_codes/*={}*/);
@Namespace("arrow") public static native @SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType dense_union(
    @Const @ByRef ArrayVector children);
...
///
///
@Namespace("arrow") public static native @SharedPtr @Cast({"", "std::shared_ptr<arrow::Field>"}) Field field(
...
@Namespace("arrow") @MemberGetter public static native @Cast("const int64_t") long kDefaultBufferAlignment();
 ...
 * 
 *  @param type_id [in] the type-id to check
 *  @return whether type-id is an integer type one */

///
@Namespace("arrow") public static native @Cast("const bool") boolean is_integer(@Cast("arrow::Type::type") int type_id);
...
///
@Namespace("arrow") public static native @Cast("const bool") boolean is_signed_integer(@Cast("arrow::Type::type") int type_id);
...
///
@Namespace("arrow") public static native @Cast("const bool") boolean is_unsigned_integer(@Cast("arrow::Type::type") int type_id);
...
///
///
@Namespace("arrow") public static native @Cast("const bool") boolean is_floating(@Cast("arrow::Type::type") int type_id);

/** \brief Check for a numeric type
 * 
 *  This predicate doesn't match decimals (see {@code is_decimal}).
 * 
 *  @param type_id [in] the type-id to check
 *  @return whether type-id is a numeric type one */

///
@Namespace("arrow") public static native @Cast("const bool") boolean is_numeric(@Cast("arrow::Type::type") int type_id);
...
///
///
@Namespace("arrow") public static native @Cast("const bool") boolean is_decimal(@Cast("arrow::Type::type") int type_id);
...
///
///
@Namespace("arrow") public static native @Cast("const bool") boolean is_primitive(@Cast("arrow::Type::type") int type_id);
...
///
@Namespace("arrow") public static native @Cast("const bool") boolean is_base_binary_like(@Cast("arrow::Type::type") int type_id);
...
///
@Namespace("arrow") public static native @Cast("const bool") boolean is_binary_like(@Cast("arrow::Type::type") int type_id);
...
///
@Namespace("arrow") public static native @Cast("const bool") boolean is_large_binary_like(@Cast("arrow::Type::type") int type_id);
...
///
@Namespace("arrow") public static native @Cast("const bool") boolean is_binary(@Cast("arrow::Type::type") int type_id);
...
///
@Namespace("arrow") public static native @Cast("const bool") boolean is_string(@Cast("arrow::Type::type") int type_id);
...
///
@Namespace("arrow") public static native @Cast("const bool") boolean is_temporal(@Cast("arrow::Type::type") int type_id);
...
///
@Namespace("arrow") public static native @Cast("const bool") boolean is_interval(@Cast("arrow::Type::type") int type_id);
...
///
@Namespace("arrow") public static native @Cast("const bool") boolean is_dictionary(@Cast("arrow::Type::type") int type_id);
...
///
@Namespace("arrow") public static native @Cast("const bool") boolean is_fixed_size_binary(@Cast("arrow::Type::type") int type_id);
...
///
@Namespace("arrow") public static native @Cast("const bool") boolean is_fixed_width(@Cast("arrow::Type::type") int type_id);
...
///
@Namespace("arrow") public static native @Cast("const bool") boolean is_list_like(@Cast("arrow::Type::type") int type_id);
...
///
@Namespace("arrow") public static native @Cast("const bool") boolean is_nested(@Cast("arrow::Type::type") int type_id);
...
///
///
@Namespace("arrow") public static native @Cast("const bool") boolean is_union(@Cast("arrow::Type::type") int type_id);
...
///
///
@Namespace("arrow") public static native @Cast("bool") boolean is_integer(@Const @ByRef DataType type);
...
///
///
@Namespace("arrow") public static native @Cast("bool") boolean is_signed_integer(@Const @ByRef DataType type);
...
///
///
@Namespace("arrow") public static native @Cast("bool") boolean is_unsigned_integer(@Const @ByRef DataType type);
...
///
///
@Namespace("arrow") public static native @Cast("bool") boolean is_floating(@Const @ByRef DataType type);
...
///
///
@Namespace("arrow") public static native @Cast("bool") boolean is_numeric(@Const @ByRef DataType type);
...
///
///
@Namespace("arrow") public static native @Cast("bool") boolean is_decimal(@Const @ByRef DataType type);
...
///
///
@Namespace("arrow") public static native @Cast("bool") boolean is_primitive(@Const @ByRef DataType type);
...
///
///
@Namespace("arrow") public static native @Cast("bool") boolean is_base_binary_like(@Const @ByRef DataType type);
...
///
///
@Namespace("arrow") public static native @Cast("bool") boolean is_binary_like(@Const @ByRef DataType type);
...
///
///
@Namespace("arrow") public static native @Cast("bool") boolean is_large_binary_like(@Const @ByRef DataType type);
...
///
///
@Namespace("arrow") public static native @Cast("bool") boolean is_binary(@Const @ByRef DataType type);
...
///
///
@Namespace("arrow") public static native @Cast("bool") boolean is_string(@Const @ByRef DataType type);
...
///
///
@Namespace("arrow") public static native @Cast("bool") boolean is_temporal(@Const @ByRef DataType type);
...
///
///
@Namespace("arrow") public static native @Cast("bool") boolean is_interval(@Const @ByRef DataType type);
...
///
///
@Namespace("arrow") public static native @Cast("bool") boolean is_dictionary(@Const @ByRef DataType type);
...
///
///
@Namespace("arrow") public static native @Cast("bool") boolean is_fixed_size_binary(@Const @ByRef DataType type);
...
///
///
@Namespace("arrow") public static native @Cast("bool") boolean is_fixed_width(@Const @ByRef DataType type);
...
///
///
@Namespace("arrow") public static native @Cast("bool") boolean is_list_like(@Const @ByRef DataType type);
...
///
///
@Namespace("arrow") public static native @Cast("bool") boolean is_nested(@Const @ByRef DataType type);
 ...
 * 
 *  Convenience for checking using the type's id */
@Namespace("arrow") public static native @Cast("bool") boolean is_union(@Const @ByRef DataType type);
...
// Targeting ../BasicDecimal256256GenericBasicDecimal.java
 ...
 * 
 *  If {@code use_threads} is true, the global CPU executor will be used.  Each call to
 *    the iterator will simply wait until the next item is available.  Tasks may run in
 *    the background between calls.
 * 
 *  If {@code use_threads} is false, the calling thread only will be used.  Each call to
...
// Targeting ../AsyncTaskScheduler.java


// Targeting ../ThrottledAsyncTaskScheduler.java
...
///
///
@Namespace("arrow") public static native @Cast("std::ostream*") @ByRef @Name("operator <<") Pointer shiftLeft(@Cast("std::ostream*") @ByRef Pointer os, @Const @ByRef TypeHolder type);
...
@Namespace("arrow") public static native void PrintTo(@Const @ByRef Field field, @Cast("std::ostream*") Pointer os);
...
@Namespace("arrow") public static native void PrintTo(@Const @ByRef FieldRef ref, @Cast("std::ostream*") Pointer os);

@Namespace("arrow") public static native @Cast("std::ostream*") @ByRef @Name("operator <<") Pointer shiftLeft(@Cast("std::ostream*") @ByRef Pointer os, @Const @ByRef FieldRef arg1);
...
@Namespace("arrow") public static native void PrintTo(@Const @ByRef Schema s, @Cast("std::ostream*") Pointer os);
...
@Namespace("arrow") public static native @Const @ByRef DataTypeVector BinaryTypes();
...
@Namespace("arrow") public static native @Const @ByRef DataTypeVector DurationTypes();
...
///
@Namespace("arrow") public static native void PrintTo(@Const @ByRef Scalar scalar, @Cast("std::ostream*") Pointer os);
...
// Targeting ../BufferSpan.java


// Targeting ../ArraySpan.java




///
@Namespace("arrow::internal") public static native void FillZeroLengthArray(@Const DataType type, ArraySpan span);
 ...
 * 
 *  @param type [in] the data type of the empty Array
 *  @param pool [in] the memory pool to allocate memory from
 *  @return the resulting Array */
@Namespace("arrow") public static native @ByVal ArrayResult MakeEmptyArray(@SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType type,
                                              MemoryPool pool/*=arrow::default_memory_pool()*/);
@Namespace("arrow") public static native @ByVal ArrayResult MakeEmptyArray(@SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType type);
...
@Namespace("arrow") public static native @ByVal ArrayBuilderUniqueResult MakeBuilder(
...
@Namespace("arrow") public static native @ByVal ArrayBuilderUniqueResult MakeBuilderExactIndex(
    @SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType type, MemoryPool pool/*=arrow::default_memory_pool()*/);
@Namespace("arrow") public static native @ByVal ArrayBuilderUniqueResult MakeBuilderExactIndex(
    @SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType type);
...
@Namespace("arrow") public static native @ByVal ArrayBuilderUniqueResult MakeDictionaryBuilder(
...
// Targeting ../GlobalOptions.java



@Namespace("arrow") public static native @ByVal @NoException(true) Status Initialize(@Const @ByRef GlobalOptions options);
...
@Namespace("arrow") public static native void PrintTo(@Const @ByRef Datum arg0, @Cast("std::ostream*") Pointer arg1);

@Namespace("arrow") public static native @StdString String ToString(Datum.Kind kind);
...
// Targeting ../RecordBatchWithMetadata.java
 ...
 *  :func:{@code arrow::PromoteTableToSchema} is used to unify schemas.
 * 
 *  Tables are concatenated in order they are provided in and the order of
 *  rows within tables will be preserved.
 * 
 *  @param tables [in] a std::vector of Tables to be concatenated
 *  @param options [in] specify how to unify schema of input tables
 *  @param memory_pool [in] MemoryPool to be used if null-filled arrays need to
...
@Namespace("arrow::csv") public enum QuotingStyle {
  ...
  None(2);
    ...
    public final int value;
    private QuotingStyle(int v) { this.value = v; }
    private QuotingStyle(QuotingStyle e) { this.value = e.value; }
    public QuotingStyle intern() { for (QuotingStyle e : values()) if (e.value == value) return e; return this; }
    @Override public String toString() { return intern().name(); }
}
...
@Namespace("arrow::csv") public static native @ByVal LongFuture CountRowsAsync(@ByVal IOContext io_context,
                               ...
                               @Const @ByRef ReadOptions arg3, @Const @ByRef CsvParseOptions arg4);
 ...
 *  {@code ReadOptions::block_size}). Each block is converted to a {@code RecordBatch}. Yielded
 *  batches have a consistent schema but may differ in row count.
 * 
 *  The supplied {@code ParseOptions} are used to determine a schema, based either on a
 *  provided explicit schema or inferred from the first non-empty block.
 *  Afterwards, the target schema is frozen. If {@code UnexpectedFieldBehavior::InferType} is
 *  specified, unexpected fields will only be inferred for the first block. Afterwards
 *  they'll be treated as errors.
 * 
 *  If {@code ReadOptions::use_threads} is {@code true}, each block's parsing/decoding task will be
 *  parallelized on the given {@code cpu_executor} (with readahead corresponding to the
 *  executor's capacity). If an executor isn't provided, the global thread pool will be
 *  used.
 * 
 *  If {@code ReadOptions::use_threads} is {@code false}, computations will be run on the calling
 *  thread and {@code cpu_executor} will be ignored. */
...
@Namespace("arrow::compute") public enum CalendarUnit {
  NANOSECOND((byte)(0)),
  MICROSECOND((byte)(1)),
  MILLISECOND((byte)(2)),
  SECOND((byte)(3)),
  ...
  YEAR((byte)(10));
    ...
    public final byte value;
    private CalendarUnit(byte v) { this.value = v; }
    private CalendarUnit(CalendarUnit e) { this.value = e.value; }
    public CalendarUnit intern() { for (CalendarUnit e : values()) if (e.value == value) return e; return this; }
    @Override public String toString() { return intern().name(); }
}
// Targeting ../RoundTemporalOptions.java
...
// Targeting ../StructFieldOptions.java
...
// Targeting ../ListSliceOptions.java
...
// Targeting ../Utf8NormalizeOptions.java


// Targeting ../RandomOptions.java


// Targeting ../MapLookupOptions.java
 ...
 * 
 *  @param arg [in] the exponent
 *  @param ctx [in] the function execution context, optional
 *  @return the element-wise Euler's number raised to the power of exponent */

///
@Namespace("arrow::compute") public static native @ByVal DatumResult Exp(@Const @ByRef Datum arg, ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult Exp(@Const @ByRef Datum arg);
 ...
 *  If argument is null the result will be null.
 * 
 *  @param arg [in] The values to compute the square-root for.
 *  @param options [in] arithmetic options (overflow handling), optional
 *  @param ctx [in] the function execution context, optional
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult Sqrt(@Const @ByRef Datum arg, @ByVal(nullValue = "arrow::compute::ArithmeticOptions()") ArithmeticOptions options,
                   ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult Sqrt(@Const @ByRef Datum arg);
 ...
 *  If argument is null the result will be null.
 * 
 *  @param arg [in] the temporal value to ceil
 *  @param options [in] temporal rounding options, optional
 *  @param ctx [in] the function execution context, optional
 *  @return the element-wise rounded value
 * 
 *  @since 7.0.0
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult CeilTemporal(
    @Const @ByRef Datum arg, @ByVal(nullValue = "arrow::compute::RoundTemporalOptions::Defaults()") RoundTemporalOptions options,
    ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult CeilTemporal(
    @Const @ByRef Datum arg);
 ...
 *  If argument is null the result will be null.
 * 
 *  @param arg [in] the temporal value to floor
 *  @param options [in] temporal rounding options, optional
 *  @param ctx [in] the function execution context, optional
 *  @return the element-wise rounded value
 * 
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult FloorTemporal(
    @Const @ByRef Datum arg, @ByVal(nullValue = "arrow::compute::RoundTemporalOptions::Defaults()") RoundTemporalOptions options,
    ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult FloorTemporal(
    @Const @ByRef Datum arg);
 ...
 *  If argument is null the result will be null.
 * 
 *  @param arg [in] the temporal value to round
 *  @param options [in] temporal rounding options, optional
 *  @param ctx [in] the function execution context, optional
 *  @return the element-wise rounded value
 * 
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult RoundTemporal(
    @Const @ByRef Datum arg, @ByVal(nullValue = "arrow::compute::RoundTemporalOptions::Defaults()") RoundTemporalOptions options,
    ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult RoundTemporal(
    @Const @ByRef Datum arg);
...
/** \brief IsLeapYear returns if a year is a leap year for each element of {@code values}
 * 
 *  @param values [in] input to extract leap year indicator from
 *  @param ctx [in] the function execution context, optional
 *  @return the resulting datum
 * 
 *  @since 8.0.0
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult IsLeapYear(@Const @ByRef Datum values, ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult IsLeapYear(@Const @ByRef Datum values);
 ...
 * 
 *  @param values [in] input to extract (year, month, day) struct from
 *  @param ctx [in] the function execution context, optional
 *  @return the resulting datum
 * 
 *  @since 7.0.0
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult YearMonthDay(@Const @ByRef Datum values, ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult YearMonthDay(@Const @ByRef Datum values);
...
/** \brief USYear returns US epidemiological year number for each element of {@code values}.
 ...
 * 
 *  @param values [in] input to extract US epidemiological year from
 *  @param ctx [in] the function execution context, optional
 *  @return the resulting datum
 * 
 *  @since 8.0.0
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult USYear(@Const @ByRef Datum values, ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult USYear(@Const @ByRef Datum values);
 ...
 *  {@code StrptimeOptions::format} at time resolution {@code Strftime::unit}. Parse errors are
 *  raised depending on the {@code Strftime::error_is_null} setting.
 * 
 *  @param values [in] input strings
 *  @param options [in] for setting format string, unit and error_is_null
 *  @param ctx [in] the function execution context, optional
 *  @return the resulting datum
 * 
 *  @since 8.0.0
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult Strptime(@Const @ByRef Datum values, @ByVal StrptimeOptions options,
                                    ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult Strptime(@Const @ByRef Datum values, @ByVal StrptimeOptions options);
 ...
 *  element of {@code values}
 * 
 *  @param values [in] input to extract daylight savings indicator from
 *  @param ctx [in] the function execution context, optional
 *  @return the resulting datum
 * 
 *  @since 8.0.0
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult IsDaylightSavings(@Const @ByRef Datum values,
                                             ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult IsDaylightSavings(@Const @ByRef Datum values);

/** \brief Years Between finds the number of years between two values
 * 
 *  @param left [in] input treated as the start time
 *  @param right [in] input treated as the end time
 *  @param ctx [in] the function execution context, optional
 *  @return the resulting datum
 * 
 *  @since 8.0.0
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult YearsBetween(@Const @ByRef Datum left, @Const @ByRef Datum right,
                                        ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult YearsBetween(@Const @ByRef Datum left, @Const @ByRef Datum right);
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult QuartersBetween(@Const @ByRef Datum left, @Const @ByRef Datum right,
                                           ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult QuartersBetween(@Const @ByRef Datum left, @Const @ByRef Datum right);
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult MonthsBetween(@Const @ByRef Datum left, @Const @ByRef Datum right,
                                         ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult MonthsBetween(@Const @ByRef Datum left, @Const @ByRef Datum right);
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult WeeksBetween(@Const @ByRef Datum left, @Const @ByRef Datum right,
                                        ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult WeeksBetween(@Const @ByRef Datum left, @Const @ByRef Datum right);
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult MonthDayNanoBetween(@Const @ByRef Datum left, @Const @ByRef Datum right,
                                               ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult MonthDayNanoBetween(@Const @ByRef Datum left, @Const @ByRef Datum right);
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult DayTimeBetween(@Const @ByRef Datum left, @Const @ByRef Datum right,
                                          ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult DayTimeBetween(@Const @ByRef Datum left, @Const @ByRef Datum right);
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult DaysBetween(@Const @ByRef Datum left, @Const @ByRef Datum right,
                                       ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult DaysBetween(@Const @ByRef Datum left, @Const @ByRef Datum right);
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult HoursBetween(@Const @ByRef Datum left, @Const @ByRef Datum right,
                                        ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult HoursBetween(@Const @ByRef Datum left, @Const @ByRef Datum right);
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult MinutesBetween(@Const @ByRef Datum left, @Const @ByRef Datum right,
                                          ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult MinutesBetween(@Const @ByRef Datum left, @Const @ByRef Datum right);
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult SecondsBetween(@Const @ByRef Datum left, @Const @ByRef Datum right,
                                          ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult SecondsBetween(@Const @ByRef Datum left, @Const @ByRef Datum right);
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult MillisecondsBetween(@Const @ByRef Datum left, @Const @ByRef Datum right,
                                               ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult MillisecondsBetween(@Const @ByRef Datum left, @Const @ByRef Datum right);
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult MicrosecondsBetween(@Const @ByRef Datum left, @Const @ByRef Datum right,
                                               ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult MicrosecondsBetween(@Const @ByRef Datum left, @Const @ByRef Datum right);
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult NanosecondsBetween(@Const @ByRef Datum left, @Const @ByRef Datum right,
                                              ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult NanosecondsBetween(@Const @ByRef Datum left, @Const @ByRef Datum right);
 ...
 * 
 *  @param map [in] to look in
 *  @param options [in] to pass a query key and choose which matching keys to return
 *  (FIRST, LAST or ALL)
 *  @param ctx [in] the function execution context, optional
 *  @return the resulting datum
 * 
 *  @since 8.0.0
 *  \note API not yet finalized */
@Namespace("arrow::compute") public static native @ByVal DatumResult MapLookup(@Const @ByRef Datum map, @ByVal MapLookupOptions options,
                                     ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult MapLookup(@Const @ByRef Datum map, @ByVal MapLookupOptions options);
  // namespace compute
  // namespace arrow
...
// Targeting ../RankOptions.java


// Targeting ../PartitionNthOptions.java


// Targeting ../CumulativeSumOptions.java
...
@Namespace("arrow::compute::internal") public static native @Cast("int64_t") long GetFilterOutputSize(@Const @ByRef ArraySpan filter,
...
@Namespace("arrow::compute::internal") public static native @ByVal ArrayDataResult GetTakeIndices(
    @Const @ByRef ArraySpan filter, FilterOptions.NullSelectionBehavior null_selection,
    MemoryPool memory_pool/*=arrow::default_memory_pool()*/);
@Namespace("arrow::compute::internal") public static native @ByVal ArrayDataResult GetTakeIndices(
    @Const @ByRef ArraySpan filter, FilterOptions.NullSelectionBehavior null_selection);
@Namespace("arrow::compute::internal") public static native @ByVal ArrayDataResult GetTakeIndices(
    @Const @ByRef ArraySpan filter, @Cast("arrow::compute::FilterOptions::NullSelectionBehavior") int null_selection,
    MemoryPool memory_pool/*=arrow::default_memory_pool()*/);
@Namespace("arrow::compute::internal") public static native @ByVal ArrayDataResult GetTakeIndices(
    @Const @ByRef ArraySpan filter, @Cast("arrow::compute::FilterOptions::NullSelectionBehavior") int null_selection);
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult FillNullForward(@Const @ByRef Datum values, ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult FillNullForward(@Const @ByRef Datum values);
...
///
///
@Namespace("arrow::compute") public static native @ByVal DatumResult FillNullBackward(@Const @ByRef Datum values, ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult FillNullBackward(@Const @ByRef Datum values);
...
@Namespace("arrow::compute") public static native @ByVal DatumResult CumulativeSum(
    @Const @ByRef Datum values,
    @Const @ByRef(nullValue = "arrow::compute::CumulativeSumOptions::Defaults()") CumulativeSumOptions options,
    ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult CumulativeSum(
    @Const @ByRef Datum values);
...
// Targeting ../ArrayKernelExec.java
...
// Targeting ../ScalarAggregateConsume.java


// Targeting ../ScalarAggregateMerge.java


// Targeting ../ScalarAggregateFinalize.java


// Targeting ../ScalarAggregateKernel.java


// Targeting ../HashAggregateResize.java


// Targeting ../HashAggregateConsume.java


// Targeting ../HashAggregateMerge.java


// Targeting ../HashAggregateFinalize.java
...
// Targeting ../QueryContext.java


// Targeting ../QueryOptions.java


// Targeting ../SinkNodeConsumer.java



@Namespace("arrow::compute") public static native ExecContext default_exec_context();
@Namespace("arrow::compute") public static native ExecContext threaded_exec_context();
...
@Namespace("arrow::compute") public static native void PrintTo(@Const @ByRef Expression arg0, @Cast("std::ostream*") Pointer arg1);
...
@Namespace("arrow::compute") public static native @ByVal ExpressionResult RemoveNamedRefs(@ByVal Expression expression);
...
@Namespace("arrow::compute") public static native @ByVal ExecBatchResult MakeExecBatch(@Const @ByRef Schema full_schema,
                                             ...
                                             @ByVal(nullValue = "arrow::compute::Expression(literal(true))") Expression guarantee);
@Namespace("arrow::compute") public static native @ByVal ExecBatchResult MakeExecBatch(@Const @ByRef Schema full_schema,
                                             @Const @ByRef Datum partial);
...
@Namespace("arrow::compute") public static native void PrintTo(@Const @ByRef ExecBatch arg0, @Cast("std::ostream*") Pointer arg1);
// Targeting ../ExecValue.java


// Targeting ../ExecResult.java


// Targeting ../ExecSpan.java
...
///
@Namespace("arrow::compute") public static native @ByVal DatumResult CallFunction(@StdString String func_name, @Const @ByRef ExecBatch batch,
                           @Const FunctionOptions options, ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult CallFunction(@StdString String func_name, @Const @ByRef ExecBatch batch,
                           @Const FunctionOptions options);
@Namespace("arrow::compute") public static native @ByVal DatumResult CallFunction(@StdString BytePointer func_name, @Const @ByRef ExecBatch batch,
                           @Const FunctionOptions options, ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult CallFunction(@StdString BytePointer func_name, @Const @ByRef ExecBatch batch,
                           @Const FunctionOptions options);
 ...
 * 
 *  This function creates and initializes a {@code FunctionExecutor} appropriate
 *  for the given function name, input types and function options. */

///
@Namespace("arrow::compute") public static native @ByVal FunctionExecutorResult GetFunctionExecutor(
    @StdString String func_name, @StdVector TypeHolder in_types,
    @Const FunctionOptions options/*=nullptr*/, FunctionRegistry func_registry/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal FunctionExecutorResult GetFunctionExecutor(
    @StdString String func_name, @StdVector TypeHolder in_types);
@Namespace("arrow::compute") public static native @ByVal FunctionExecutorResult GetFunctionExecutor(
    @StdString BytePointer func_name, @StdVector TypeHolder in_types,
    @Const FunctionOptions options/*=nullptr*/, FunctionRegistry func_registry/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal FunctionExecutorResult GetFunctionExecutor(
    @StdString BytePointer func_name, @StdVector TypeHolder in_types);
...
@Namespace("arrow::compute") public static native @ByVal FunctionExecutorResult GetFunctionExecutor(
    @StdString String func_name, @Const @ByRef DatumVector args,
    @Const FunctionOptions options/*=nullptr*/, FunctionRegistry func_registry/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal FunctionExecutorResult GetFunctionExecutor(
    @StdString String func_name, @Const @ByRef DatumVector args);
@Namespace("arrow::compute") public static native @ByVal FunctionExecutorResult GetFunctionExecutor(
    @StdString BytePointer func_name, @Const @ByRef DatumVector args,
    @Const FunctionOptions options/*=nullptr*/, FunctionRegistry func_registry/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal FunctionExecutorResult GetFunctionExecutor(
    @StdString BytePointer func_name, @Const @ByRef DatumVector args);
...
// Targeting ../FunctionExecutor.java
...
@Namespace("arrow::compute::detail") public static native @Const Kernel DispatchExactImpl(@Const Function func, @StdVector TypeHolder arg1);

/** \brief Return an error message if no Kernel is found. */
@Namespace("arrow::compute::detail") public static native @ByVal Status NoMatchingKernel(@Const Function func, @StdVector TypeHolder arg1);
...
///
@Namespace("arrow::compute") public static native @ByVal ArrayResult Cast(@Const @ByRef Array value, @Const @ByRef TypeHolder to_type,
 ...
 *  @since 1.0.0
 *  \note API not yet finalized */
@Namespace("arrow::compute") public static native @ByVal DatumResult Cast(@Const @ByRef Datum value, @Const @ByRef TypeHolder to_type,
                   @Const @ByRef(nullValue = "arrow::compute::CastOptions::Safe()") CastOptions options,
                   ExecContext ctx/*=nullptr*/);
@Namespace("arrow::compute") public static native @ByVal DatumResult Cast(@Const @ByRef Datum value, @Const @ByRef TypeHolder to_type);
...
@Namespace("arrow::ipc::internal::json") public static native @ByVal ArrayResult ArrayFromJSON(@SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType arg0,
                                             @StdString String json);
@Namespace("arrow::ipc::internal::json") public static native @ByVal ArrayResult ArrayFromJSON(@SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType arg0,
                                             @StdString BytePointer json);

@Namespace("arrow::ipc::internal::json") public static native @ByVal Status ChunkedArrayFromJSON(@SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType type,
                            @Const @ByRef StringVector json_strings,
                            @SharedPtr ChunkedArray out);

@Namespace("arrow::ipc::internal::json") public static native @ByVal Status DictArrayFromJSON(@SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType arg0, @ByVal @StdString String indices_json,
                         @ByVal @StdString String dictionary_json, @SharedPtr Array out);

@Namespace("arrow::ipc::internal::json") public static native @ByVal Status ScalarFromJSON(@SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType arg0, @ByVal @StdString String json,
                      @SharedPtr Scalar out);

@Namespace("arrow::ipc::internal::json") public static native @ByVal Status DictScalarFromJSON(@SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType arg0, @ByVal @StdString String index_json,
                          @ByVal @StdString String dictionary_json, @SharedPtr Scalar out);
 ...
 *  @param fields_loader [in] the function for loading subset of fields from the given file
...
///
///
@Namespace("arrow::ipc") public static native @ByVal MessageUniqueResult ReadMessage(
    @Cast("const int64_t") long offset, int metadata_length, RandomAccessFile file,
    @Cast("const arrow::ipc::FieldsLoaderFunction*") @ByRef(nullValue = "arrow::ipc::FieldsLoaderFunction{}") Pointer fields_loader);
@Namespace("arrow::ipc") public static native @ByVal MessageUniqueResult ReadMessage(
    @Cast("const int64_t") long offset, int metadata_length, RandomAccessFile file);
...
@Namespace("arrow::ipc") public static native @ByVal MessageUniqueResult ReadMessage(
    @SharedPtr ArrowBuffer metadata, @SharedPtr ArrowBuffer body);
 ...
 *  @param batch [in] the RecordBatch that is being serialized
 *  @param custom_metadata [in] the custom metadata to be serialized with the record batch
 *  @param options [in] options for serialization
 *  @param out [out] the returned IpcPayload
 *  @return Status */
@Namespace("arrow::ipc") public static native @ByVal Status GetRecordBatchPayload(
    @Const @ByRef RecordBatch batch,
    @SharedPtr @Cast({"const arrow::KeyValueMetadata*", "std::shared_ptr<const arrow::KeyValueMetadata>"}) KeyValueMetadata custom_metadata,
    @Const @ByRef IpcWriteOptions options, IpcPayload out);
...
// Parsed from arrow/util/small_vector.h
...
// Parsed from arrow/util/tracing.h
