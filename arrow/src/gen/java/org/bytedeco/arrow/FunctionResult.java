...
@Name("arrow::Result<std::shared_ptr<arrow::compute::Function> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class FunctionResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FunctionResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FunctionResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public FunctionResult position(long position) {
        return (FunctionResult)super.position(position);
    }
    @Override public FunctionResult getPointer(long i) {
        return new FunctionResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public FunctionResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public FunctionResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public FunctionResult(@SharedPtr Function value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr Function value);
  ...
  ///
  ///
  public FunctionResult(@Const @ByRef FunctionResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef FunctionResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) FunctionResult put(@Const @ByRef FunctionResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef FunctionResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr Function ValueOrDie();
  public native @SharedPtr @Name("operator *") Function multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") Function access();
  ...
  public native @SharedPtr Function MoveValueUnsafe();
}
