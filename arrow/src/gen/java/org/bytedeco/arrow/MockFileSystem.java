...
public class MockFileSystem extends FileSystem {
  ...
  public native @ByVal Status CreateFile(@StdString String path, @ByVal @StdString String content,
                      @Cast("bool") boolean recursive/*=true*/);
  public native @ByVal Status CreateFile(@StdString String path, @ByVal @StdString String content);
  public native @ByVal Status CreateFile(@StdString BytePointer path, @ByVal @StdString String content,
                      @Cast("bool") boolean recursive/*=true*/);
  public native @ByVal Status CreateFile(@StdString BytePointer path, @ByVal @StdString String content);
