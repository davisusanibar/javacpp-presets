...
@Name("arrow::Result<std::shared_ptr<arrow::io::BufferOutputStream> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class BufferOutputStreamResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public BufferOutputStreamResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public BufferOutputStreamResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public BufferOutputStreamResult getPointer(long i) {
        return new BufferOutputStreamResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public BufferOutputStreamResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public BufferOutputStreamResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public BufferOutputStreamResult(@SharedPtr BufferOutputStream value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr BufferOutputStream value);
  ...
  ///
  ///
  public BufferOutputStreamResult(@Const @ByRef BufferOutputStreamResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef BufferOutputStreamResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) BufferOutputStreamResult put(@Const @ByRef BufferOutputStreamResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef BufferOutputStreamResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr BufferOutputStream ValueOrDie();
  public native @SharedPtr @Name("operator *") BufferOutputStream multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") BufferOutputStream access();
  ...
  public native @SharedPtr BufferOutputStream ValueUnsafe();

  

  public native @SharedPtr BufferOutputStream MoveValueUnsafe();
}
