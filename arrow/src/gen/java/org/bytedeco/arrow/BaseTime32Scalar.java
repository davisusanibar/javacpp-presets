...
public class BaseTime32Scalar extends BaseBaseTime32Scalar {
  ...
  public BaseTime32Scalar(@Cast("arrow::TemporalScalar<arrow::Time32Type>::ValueType") int value, TimeUnit.type unit) { super((Pointer)null); allocate(value, unit); }
  private native void allocate(@Cast("arrow::TemporalScalar<arrow::Time32Type>::ValueType") int value, TimeUnit.type unit);
  public BaseTime32Scalar(@Cast("arrow::TemporalScalar<arrow::Time32Type>::ValueType") int value, @Cast("arrow::TimeUnit::type") int unit) { super((Pointer)null); allocate(value, unit); }
