...
public class ListScalar extends BaseListScalar {
    ...
    public ListScalar(@SharedPtr @Cast({"", "std::shared_ptr<arrow::Array>"}) Array value, @SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType type,
  ...
  public ListScalar(@SharedPtr @Cast({"", "std::shared_ptr<arrow::Array>"}) Array value, @Cast("bool") boolean is_valid/*=true*/) { super((Pointer)null); allocate(value, is_valid); }
