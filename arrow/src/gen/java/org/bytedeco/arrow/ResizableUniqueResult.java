...
@Name("arrow::Result<std::unique_ptr<arrow::ResizableBuffer> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class ResizableUniqueResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ResizableUniqueResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ResizableUniqueResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public ResizableUniqueResult getPointer(long i) {
        return new ResizableUniqueResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public ResizableUniqueResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ResizableUniqueResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public ResizableUniqueResult(@UniquePtr ResizableBuffer value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@UniquePtr ResizableBuffer value);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef ResizableUniqueResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @UniquePtr ResizableBuffer ValueOrDie();
  public native @UniquePtr @Name("operator *") ResizableBuffer multiply();
  
  ///
  ///
  public native @UniquePtr @Name("operator ->") ResizableBuffer access();
  ...
  public native @UniquePtr ResizableBuffer ValueUnsafe();

  

  public native @UniquePtr ResizableBuffer MoveValueUnsafe();
}
