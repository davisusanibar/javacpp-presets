...
@Name("arrow::Result<std::unique_ptr<arrow::ArrayBuilder> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class ArrayBuilderUniqueResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ArrayBuilderUniqueResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ArrayBuilderUniqueResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ArrayBuilderUniqueResult position(long position) {
        return (ArrayBuilderUniqueResult)super.position(position);
    }
    @Override public ArrayBuilderUniqueResult getPointer(long i) {
        return new ArrayBuilderUniqueResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public ArrayBuilderUniqueResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ArrayBuilderUniqueResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public ArrayBuilderUniqueResult(@UniquePtr ArrayBuilder value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@UniquePtr ArrayBuilder value);
  ...
  ///
  ///
  public ArrayBuilderUniqueResult(@Const @ByRef ArrayBuilderUniqueResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef ArrayBuilderUniqueResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) ArrayBuilderUniqueResult put(@Const @ByRef ArrayBuilderUniqueResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef ArrayBuilderUniqueResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @UniquePtr ArrayBuilder ValueOrDie();
  public native @UniquePtr @Name("operator *") ArrayBuilder multiply();
  
  ///
  ///
  public native @UniquePtr @Name("operator ->") ArrayBuilder access();
  ...
  public native @UniquePtr ArrayBuilder ValueUnsafe();

  

  public native @UniquePtr ArrayBuilder MoveValueUnsafe();
}
