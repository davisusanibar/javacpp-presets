...
public class DatumResult extends Pointer {
    ...
    public DatumResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public DatumResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public DatumResult getPointer(long i) {
        return new DatumResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public DatumResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public DatumResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) Datum value);
  ...
  ///
  ///
  public DatumResult(@Const @ByRef DatumResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef DatumResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) DatumResult put(@Const @ByRef DatumResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef Datum ValueOrDie();
  public native @ByRef @Name("operator *") Datum multiply();
  
  ///
  ///
  public native @Name("operator ->") Datum access();
  ...
  public native @Const @ByRef Datum ValueUnsafe();

  

  public native @ByVal Datum MoveValueUnsafe();
}
