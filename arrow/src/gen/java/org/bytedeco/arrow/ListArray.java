...
public class ListArray extends BaseListArray {
   ...
   *  @param null_bitmap [in] Optional validity bitmap
   *  @param null_count [in] Optional null count in null_bitmap */
  public static native @ByVal ListArrayResult FromArrays(
        @Const @ByRef Array offsets, @Const @ByRef Array values, MemoryPool pool/*=arrow::default_memory_pool()*/,
        @SharedPtr ArrowBuffer null_bitmap/*=nullptr*/,
  ...
  ///
  public static native @ByVal ListArrayResult FromArrays(
        @SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType type, @Const @ByRef Array offsets, @Const @ByRef Array values,
