...
public class Scalar extends Pointer {
  ...
  public static native @ByVal ScalarResult Parse(@SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType type,
                                                 @ByVal @StdString String repr);
  ...
  public native @ByVal Status Accept(ScalarVisitor visitor);

  /** \brief EXPERIMENTAL Enable obtaining shared_ptr<Scalar> from a const
   *  Scalar& context. */
  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::Scalar>"}) Scalar GetSharedPtr();
}
