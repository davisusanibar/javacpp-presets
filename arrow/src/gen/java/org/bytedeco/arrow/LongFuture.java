...
@Name("arrow::Future<int64_t>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class LongFuture extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public LongFuture(Pointer p) { super(p); }
  ...
  public LongFuture() { super((Pointer)null); allocate(); }
...
// #endif
  ...
  ///
  public native @Const @ByRef LongResult result();
  ...
  public native @ByRef(true) LongResult MoveResult();
  ...
  public native void MarkFinished(@ByVal LongResult res);
  ...
  public static native @ByVal LongFuture Make();

  /** \brief Producer API: instantiate a finished Future */
  public static native @ByVal LongFuture MakeFinished(@ByVal LongResult res);
  ...
  public LongFuture(@Cast("arrow::Future<int64_t>::ValueType") long val) { super((Pointer)null); allocate(val); }
  private native void allocate(@Cast("arrow::Future<int64_t>::ValueType") long val);

  /** \brief Implicit constructor to create a future from a Result, enabling use
   *      of macros like ARROW_ASSIGN_OR_RAISE. */
  public LongFuture(@ByVal LongResult res) { super((Pointer)null); allocate(res); }
  private native void allocate(@ByVal LongResult res);

  /** \brief Implicit constructor to create a future from a Status, enabling use
   *      of macros like ARROW_RETURN_NOT_OK. */
  public LongFuture(@ByVal Status s) { super((Pointer)null); allocate(s); }
