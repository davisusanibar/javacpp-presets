...
public class FunctionDoc extends Pointer {
  ...
  public native @Cast("bool") boolean options_required(); public native FunctionDoc options_required(boolean setter);
  ...
  public FunctionDoc(@StdString String summary, @StdString String description,
                ...
                @Cast("bool") boolean options_required/*=false*/) { super((Pointer)null); allocate(summary, description, arg_names, options_class, options_required); }
  private native void allocate(@StdString String summary, @StdString String description,
                @ByVal StringVector arg_names, @StdString String options_class/*=""*/,
                @Cast("bool") boolean options_required/*=false*/);
  public FunctionDoc(@StdString String summary, @StdString String description,
