...
@Name("arrow::Result<arrow::util::Compressor::CompressResult>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class CompressResultResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public CompressResultResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public CompressResultResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public CompressResultResult position(long position) {
        return (CompressResultResult)super.position(position);
    }
    @Override public CompressResultResult getPointer(long i) {
        return new CompressResultResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public CompressResultResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public CompressResultResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) Compressor.CompressResult value);
  ...
  ///
  ///
  public CompressResultResult(@Const @ByRef CompressResultResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef CompressResultResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) CompressResultResult put(@Const @ByRef CompressResultResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef Compressor.CompressResult ValueOrDie();
  public native @ByRef @Name("operator *") Compressor.CompressResult multiply();
  
  ///
  ///
  public native @Name("operator ->") Compressor.CompressResult access();
  ...
  public native @Const @ByRef Compressor.CompressResult ValueUnsafe();

  

  public native @ByVal Compressor.CompressResult MoveValueUnsafe();
}
