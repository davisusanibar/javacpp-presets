...
@Name("arrow::Result<std::shared_ptr<arrow::io::BufferedInputStream> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class BufferedInputStreamResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public BufferedInputStreamResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public BufferedInputStreamResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public BufferedInputStreamResult position(long position) {
        return (BufferedInputStreamResult)super.position(position);
    }
    @Override public BufferedInputStreamResult getPointer(long i) {
        return new BufferedInputStreamResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public BufferedInputStreamResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public BufferedInputStreamResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public BufferedInputStreamResult(@SharedPtr BufferedInputStream value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr BufferedInputStream value);
  ...
  ///
  ///
  public BufferedInputStreamResult(@Const @ByRef BufferedInputStreamResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef BufferedInputStreamResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) BufferedInputStreamResult put(@Const @ByRef BufferedInputStreamResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef BufferedInputStreamResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr BufferedInputStream ValueOrDie();
  public native @SharedPtr @Name("operator *") BufferedInputStream multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") BufferedInputStream access();
  ...
  public native @SharedPtr BufferedInputStream ValueUnsafe();

  

  public native @SharedPtr BufferedInputStream MoveValueUnsafe();
}
