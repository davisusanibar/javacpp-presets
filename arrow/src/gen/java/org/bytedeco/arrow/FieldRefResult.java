...
@Name("arrow::Result<arrow::FieldRef>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class FieldRefResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FieldRefResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FieldRefResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public FieldRefResult getPointer(long i) {
        return new FieldRefResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public FieldRefResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public FieldRefResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) FieldRef value);
  ...
  ///
  ///
  public FieldRefResult(@Const @ByRef FieldRefResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef FieldRefResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) FieldRefResult put(@Const @ByRef FieldRefResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef FieldRefResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef FieldRef ValueOrDie();
  public native @ByRef @Name("operator *") FieldRef multiply();
  
  ///
  ///
  public native @Name("operator ->") FieldRef access();
  ...
  public native @Const @ByRef FieldRef ValueUnsafe();

  

  public native @ByVal FieldRef MoveValueUnsafe();
}
