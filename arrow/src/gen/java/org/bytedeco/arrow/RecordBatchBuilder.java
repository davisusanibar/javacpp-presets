...
public class RecordBatchBuilder extends Pointer {
  ...
  public static native @Deprecated @ByVal Status Make(@Const @SharedPtr @ByRef Schema schema, MemoryPool pool,
  ...
  public static native @ByVal RecordBatchBuilderUniqueResult Make(
        @Const @SharedPtr @ByRef Schema schema, MemoryPool pool);
   ...
   *  @return the created builder instance */
  public static native @ByVal RecordBatchBuilderUniqueResult Make(
        @Const @SharedPtr @ByRef Schema schema, MemoryPool pool, @Cast("int64_t") long initial_capacity);
   ...
   *  @return Status */
  public native @Deprecated @ByVal Status Flush(@Cast("bool") boolean reset_builders, @SharedPtr RecordBatch batch);

  /** \brief Finish current batch and reset
   *  @param batch [out] the resulting RecordBatch
   *  @return Status */
  public native @Deprecated @ByVal Status Flush(@SharedPtr RecordBatch batch);

  /** \brief Finish current batch and optionally reset
   *  @param reset_builders [in] the resulting RecordBatch
   *  @return the resulting RecordBatch */
  public native @ByVal RecordBatchResult Flush(@Cast("bool") boolean reset_builders);

  /** \brief Finish current batch and reset
   *  @return the resulting RecordBatch */
  public native @ByVal RecordBatchResult Flush();
