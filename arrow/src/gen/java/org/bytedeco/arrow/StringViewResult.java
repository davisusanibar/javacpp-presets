...
@Name("arrow::Result<std::string_view>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class StringViewResult extends Pointer {
  ...
  ///
  ///
  public StringViewResult(@ByRef(true) @StdString String value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@ByRef(true) @StdString String value);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef @StdString String ValueOrDie();
  public native @ByRef @Name("operator *") @StdString String multiply();
  
  ///
  ///
  public native @Name("operator ->") @StdString String access();
  ...
  public native @Const @ByRef @StdString String ValueUnsafe();

  

  public native @ByVal @StdString String MoveValueUnsafe();
}
