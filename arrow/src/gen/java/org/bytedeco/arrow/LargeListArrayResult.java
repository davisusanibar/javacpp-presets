...
@Name("arrow::Result<std::shared_ptr<arrow::LargeListArray> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class LargeListArrayResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public LargeListArrayResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public LargeListArrayResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public LargeListArrayResult position(long position) {
        return (LargeListArrayResult)super.position(position);
    }
    @Override public LargeListArrayResult getPointer(long i) {
        return new LargeListArrayResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public LargeListArrayResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public LargeListArrayResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@SharedPtr @ByRef(true) LargeListArray value);
  ...
  ///
  ///
  public LargeListArrayResult(@Const @ByRef LargeListArrayResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef LargeListArrayResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) LargeListArrayResult put(@Const @ByRef LargeListArrayResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef LargeListArrayResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef LargeListArray ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") LargeListArray multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") LargeListArray access();
  ...
  public native @Const @SharedPtr @ByRef LargeListArray ValueUnsafe();

  

  public native @SharedPtr @ByVal LargeListArray MoveValueUnsafe();
}
