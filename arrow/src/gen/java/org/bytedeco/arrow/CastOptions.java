...
public class CastOptions extends FunctionOptions {
  ...
  public static native @ByVal CastOptions Safe(@ByVal(nullValue = "arrow::TypeHolder{}") TypeHolder to_type);
  public static native @ByVal CastOptions Safe();

  public static native @ByVal CastOptions Unsafe(@ByVal(nullValue = "arrow::TypeHolder{}") TypeHolder to_type);
  public static native @ByVal CastOptions Unsafe();

  // Type being casted to. May be passed separate to eager function
  // compute::Cast
  public native @ByRef TypeHolder to_type(); public native CastOptions to_type(TypeHolder setter);
