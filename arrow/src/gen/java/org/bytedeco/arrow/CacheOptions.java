...
public class CacheOptions extends Pointer {
    ...
    @Override public CacheOptions getPointer(long i) {
        return new CacheOptions((Pointer)this).offsetAddress(i);
    }
  ...
  public native @Cast("bool") boolean lazy(); public native CacheOptions lazy(boolean setter);
  ...
  public static native @ByVal CacheOptions LazyDefaults();
}
