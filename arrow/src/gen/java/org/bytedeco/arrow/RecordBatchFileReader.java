...
public class RecordBatchFileReader extends Pointer {
  ...
  public native @ByVal RecordBatchWithMetadataResult ReadRecordBatchWithCustomMetadata(int i);
  ...
  ///
  public native @ByVal Status PreBufferMetadata(@StdVector IntPointer indices);
  public native @ByVal Status PreBufferMetadata(@StdVector IntBuffer indices);
  public native @ByVal Status PreBufferMetadata(@StdVector int[] indices);
