...
@Name("arrow::Result<std::unique_ptr<arrow::compute::KernelState> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class KernelStateResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public KernelStateResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public KernelStateResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public KernelStateResult position(long position) {
        return (KernelStateResult)super.position(position);
    }
    @Override public KernelStateResult getPointer(long i) {
        return new KernelStateResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public KernelStateResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public KernelStateResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public KernelStateResult(@UniquePtr @Cast({"", "std::unique_ptr<arrow::compute::KernelState>&&"}) KernelState value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@UniquePtr @Cast({"", "std::unique_ptr<arrow::compute::KernelState>&&"}) KernelState value);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef KernelStateResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @UniquePtr @ByRef KernelState ValueOrDie();
  public native @UniquePtr @ByRef @Name("operator *") KernelState multiply();
  
  ///
  ///
  public native @UniquePtr @Name("operator ->") KernelState access();
  ...
  public native @UniquePtr @Cast({"", "std::unique_ptr<arrow::compute::KernelState>&&"}) KernelState ValueUnsafe();

  

  public native @UniquePtr @Cast({"", "std::unique_ptr<arrow::compute::KernelState>&&"}) KernelState MoveValueUnsafe();
}
