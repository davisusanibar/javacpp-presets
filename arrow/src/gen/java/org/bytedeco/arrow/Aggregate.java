...
public class Aggregate extends Pointer {
  ...
  public native @SharedPtr FunctionOptions options(); public native Aggregate options(FunctionOptions setter);

  // fields to which aggregations will be applied
  public native @ByRef FieldRef target(); public native Aggregate target(FieldRef setter);

  // output field name for aggregations
  public native @StdString String name(); public native Aggregate name(String setter);
}
