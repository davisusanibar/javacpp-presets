...
@Name("arrow::Result<size_t>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class SizeTResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public SizeTResult(Pointer p) { super(p); }
   ...
   *  Result. */
  public SizeTResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public SizeTResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@Cast("size_t&&") long value);
  ...
  ///
  ///
  public SizeTResult(@Const @ByRef SizeTResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef SizeTResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) SizeTResult put(@Const @ByRef SizeTResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef SizeTResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @Cast("size_t*") @ByRef SizeTPointer ValueOrDie();
  public native @Cast("size_t*") @ByRef @Name("operator *") SizeTPointer multiply();
  
  ///
  ///
  public native @Cast("size_t*") @Name("operator ->") SizeTPointer access();
  ...
  public native @Cast("const size_t") long ValueUnsafe();

  

  public native @Cast("size_t") long MoveValueUnsafe();
}
