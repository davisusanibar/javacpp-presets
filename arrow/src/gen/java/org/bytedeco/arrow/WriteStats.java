...
public class WriteStats extends Pointer {
  ...
  public native @Cast("int64_t") long total_raw_body_size(); public native WriteStats total_raw_body_size(long setter);
  public native @Cast("int64_t") long total_serialized_body_size(); public native WriteStats total_serialized_body_size(long setter);
}
