...
@Name("arrow::Result<std::shared_ptr<arrow::ipc::feather::Reader> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class FeatherReaderResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FeatherReaderResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FeatherReaderResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public FeatherReaderResult getPointer(long i) {
        return new FeatherReaderResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public FeatherReaderResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public FeatherReaderResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public FeatherReaderResult(@SharedPtr Reader value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr Reader value);
  ...
  ///
  ///
  public FeatherReaderResult(@Const @ByRef FeatherReaderResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef FeatherReaderResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) FeatherReaderResult put(@Const @ByRef FeatherReaderResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef FeatherReaderResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr Reader ValueOrDie();
  public native @SharedPtr @Name("operator *") Reader multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") Reader access();
  ...
  public native @SharedPtr Reader ValueUnsafe();

  

  public native @SharedPtr Reader MoveValueUnsafe();
}
