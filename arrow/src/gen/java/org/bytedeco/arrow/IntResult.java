...
@Name("arrow::Result<int>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class IntResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public IntResult(Pointer p) { super(p); }
   ...
   *  Result. */
  public IntResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public IntResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@Cast("int&&") int value);
  ...
  ///
  ///
  public IntResult(@Const @ByRef IntResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef IntResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) IntResult put(@Const @ByRef IntResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef IntResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef IntPointer ValueOrDie();
  public native @ByRef @Name("operator *") IntPointer multiply();
  
  ///
  ///
  public native @Name("operator ->") IntPointer access();
  ...
  public native int ValueUnsafe();

  

  public native int MoveValueUnsafe();
}
