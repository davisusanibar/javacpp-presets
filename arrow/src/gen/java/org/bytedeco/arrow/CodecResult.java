...
@Name("arrow::Result<std::unique_ptr<arrow::util::Codec> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class CodecResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public CodecResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public CodecResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public CodecResult getPointer(long i) {
        return new CodecResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public CodecResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public CodecResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public CodecResult(@UniquePtr Codec value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@UniquePtr Codec value);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef CodecResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @UniquePtr Codec ValueOrDie();
  public native @UniquePtr @Name("operator *") Codec multiply();
  
  ///
  ///
  public native @UniquePtr @Name("operator ->") Codec access();
  ...
  public native @UniquePtr Codec MoveValueUnsafe();
}
