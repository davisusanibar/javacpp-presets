...
@Name("arrow::Future<std::shared_ptr<arrow::Buffer> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class BufferFuture extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public BufferFuture(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public BufferFuture(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public BufferFuture position(long position) {
        return (BufferFuture)super.position(position);
    }
    @Override public BufferFuture getPointer(long i) {
        return new BufferFuture((Pointer)this).offsetAddress(i);
    }
  ...
  public BufferFuture() { super((Pointer)null); allocate(); }
...
// #endif
  ...
  ///
  public native @Const @ByRef BufferResult result();
  ...
  public native @ByRef(true) BufferResult MoveResult();
  ...
  public native void MarkFinished(@ByVal BufferResult res);
  ...
  public static native @ByVal BufferFuture Make();

  /** \brief Producer API: instantiate a finished Future */
  public static native @ByVal BufferFuture MakeFinished(@ByVal BufferResult res);
  ...
  public BufferFuture(@SharedPtr ArrowBuffer val) { super((Pointer)null); allocate(val); }
  private native void allocate(@SharedPtr ArrowBuffer val);

  /** \brief Implicit constructor to create a future from a Result, enabling use
   *      of macros like ARROW_ASSIGN_OR_RAISE. */
  public BufferFuture(@ByVal BufferResult res) { super((Pointer)null); allocate(res); }
  private native void allocate(@ByVal BufferResult res);

  /** \brief Implicit constructor to create a future from a Status, enabling use
   *      of macros like ARROW_RETURN_NOT_OK. */
  public BufferFuture(@ByVal Status s) { super((Pointer)null); allocate(s); }
