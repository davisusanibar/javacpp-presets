...
public class VectorFunction extends Function {
  ...
  public VectorFunction(@StdString String name, @Const @ByRef Arity arity, @ByVal FunctionDoc doc,
  ...
  public VectorFunction(@StdString String name, @Const @ByRef Arity arity, @ByVal FunctionDoc doc) { super((Pointer)null); allocate(name, arity, doc); }
  private native void allocate(@StdString String name, @Const @ByRef Arity arity, @ByVal FunctionDoc doc);
  public VectorFunction(@StdString BytePointer name, @Const @ByRef Arity arity, @ByVal FunctionDoc doc,
                   @Const FunctionOptions default_options/*=nullptr*/) { super((Pointer)null); allocate(name, arity, doc, default_options); }
  private native void allocate(@StdString BytePointer name, @Const @ByRef Arity arity, @ByVal FunctionDoc doc,
                   @Const FunctionOptions default_options/*=nullptr*/);
  public VectorFunction(@StdString BytePointer name, @Const @ByRef Arity arity, @ByVal FunctionDoc doc) { super((Pointer)null); allocate(name, arity, doc); }
  private native void allocate(@StdString BytePointer name, @Const @ByRef Arity arity, @ByVal FunctionDoc doc);
