...
@Name("arrow::Result<std::shared_ptr<arrow::fs::FileSystem> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class FileSystemResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FileSystemResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FileSystemResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public FileSystemResult getPointer(long i) {
        return new FileSystemResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public FileSystemResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public FileSystemResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public FileSystemResult(@SharedPtr FileSystem value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr FileSystem value);
  ...
  ///
  ///
  public FileSystemResult(@Const @ByRef FileSystemResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef FileSystemResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) FileSystemResult put(@Const @ByRef FileSystemResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef FileSystemResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr FileSystem ValueOrDie();
  public native @SharedPtr @Name("operator *") FileSystem multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") FileSystem access();
  ...
  public native @SharedPtr FileSystem MoveValueUnsafe();
}
