...
public class Int16Builder extends ArrayBuilder {
  ...
  public Int16Builder(@SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType type, MemoryPool pool,
   ...
   *  @return Status */
  public native @ByVal Status AppendValues(@Cast("const arrow::NumericBuilder<arrow::Int16Type>::value_type*") ShortPointer values, @Cast("int64_t") long length, @Cast("const uint8_t*") BytePointer bitmap,
                        @Cast("int64_t") long bitmap_offset);
  public native @ByVal Status AppendValues(@Cast("const arrow::NumericBuilder<arrow::Int16Type>::value_type*") ShortBuffer values, @Cast("int64_t") long length, @Cast("const uint8_t*") ByteBuffer bitmap,
                        @Cast("int64_t") long bitmap_offset);
  public native @ByVal Status AppendValues(@Cast("const arrow::NumericBuilder<arrow::Int16Type>::value_type*") short[] values, @Cast("int64_t") long length, @Cast("const uint8_t*") byte[] bitmap,
                        @Cast("int64_t") long bitmap_offset);
