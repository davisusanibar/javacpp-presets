...
public class Executor extends Pointer {
   ...
   * 
   *  @see KeepAlive */
  public static class Resource extends Pointer {
      static { Loader.load(); }
      /** Default native constructor. */
      public Resource() { super((Pointer)null); allocate(); }
      /** Native array allocator. Access with {@link Pointer#position(long)}. */
      public Resource(long size) { super((Pointer)null); allocateArray(size); }
      /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
      public Resource(Pointer p) { super(p); }
      private native void allocate();
      private native void allocateArray(long size);
      @Override public Resource position(long position) {
          return (Resource)super.position(position);
      }
      @Override public Resource getPointer(long i) {
          return new Resource((Pointer)this).offsetAddress(i);
      }
  ...
  public native void KeepAlive(@SharedPtr Resource resource);
}
