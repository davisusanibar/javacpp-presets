...
@Name("arrow::Result<arrow::util::Compressor::FlushResult>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class FlushResultResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FlushResultResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FlushResultResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public FlushResultResult getPointer(long i) {
        return new FlushResultResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public FlushResultResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public FlushResultResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) Compressor.FlushResult value);
  ...
  ///
  ///
  public FlushResultResult(@Const @ByRef FlushResultResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef FlushResultResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) FlushResultResult put(@Const @ByRef FlushResultResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef Compressor.FlushResult ValueOrDie();
  public native @ByRef @Name("operator *") Compressor.FlushResult multiply();
  
  ///
  ///
  public native @Name("operator ->") Compressor.FlushResult access();
  ...
  public native @Const @ByRef Compressor.FlushResult ValueUnsafe();

  

  public native @ByVal Compressor.FlushResult MoveValueUnsafe();
}
