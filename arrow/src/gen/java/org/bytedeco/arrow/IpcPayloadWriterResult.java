...
@Name("arrow::Result<std::unique_ptr<arrow::ipc::internal::IpcPayloadWriter> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class IpcPayloadWriterResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public IpcPayloadWriterResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public IpcPayloadWriterResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public IpcPayloadWriterResult position(long position) {
        return (IpcPayloadWriterResult)super.position(position);
    }
    @Override public IpcPayloadWriterResult getPointer(long i) {
        return new IpcPayloadWriterResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public IpcPayloadWriterResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public IpcPayloadWriterResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public IpcPayloadWriterResult(@UniquePtr IpcPayloadWriter value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@UniquePtr IpcPayloadWriter value);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef IpcPayloadWriterResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @UniquePtr IpcPayloadWriter ValueOrDie();
  public native @UniquePtr @Name("operator *") IpcPayloadWriter multiply();
  
  ///
  ///
  public native @UniquePtr @Name("operator ->") IpcPayloadWriter access();
  ...
  public native @UniquePtr IpcPayloadWriter MoveValueUnsafe();
}
