...
public class FieldRef extends Pointer {
  ...
  public FieldRef(@StdVector FieldRef refs) { super((Pointer)null); allocate(refs); }
  private native void allocate(@StdVector FieldRef refs);
  ...
  public native @StdString String ToDotPath();
  ...
  public native @StdVector FieldRef nested_refs();
