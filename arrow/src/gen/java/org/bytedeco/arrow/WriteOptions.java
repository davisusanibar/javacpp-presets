...
public class WriteOptions extends Pointer {
  ...
  /** Field delimiter */
  public native @Cast("char") byte delimiter(); public native WriteOptions delimiter(byte setter);

  /** \brief The string to write for null values. Quotes are not allowed in this string. */
  public native @StdString String null_string(); public native WriteOptions null_string(String setter);
  ...
  public native @StdString String eol(); public native WriteOptions eol(String setter);

  /** \brief Quoting style */
  public native QuotingStyle quoting_style(); public native WriteOptions quoting_style(QuotingStyle setter);
