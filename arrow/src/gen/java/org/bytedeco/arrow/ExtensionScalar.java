...
public class ExtensionScalar extends Scalar {
  ...
  public ExtensionScalar(@SharedPtr @Cast({"", "std::shared_ptr<arrow::Scalar>"}) Scalar storage, @SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType type,
                    @Cast("bool") boolean is_valid/*=true*/) { super((Pointer)null); allocate(storage, type, is_valid); }
