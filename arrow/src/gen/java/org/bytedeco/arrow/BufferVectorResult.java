...
@Name("arrow::Result<std::vector<std::shared_ptr<arrow::Buffer> > >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class BufferVectorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public BufferVectorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public BufferVectorResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public BufferVectorResult position(long position) {
        return (BufferVectorResult)super.position(position);
    }
    @Override public BufferVectorResult getPointer(long i) {
        return new BufferVectorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public BufferVectorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public BufferVectorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) BufferVector value);
  ...
  ///
  ///
  public BufferVectorResult(@Const @ByRef BufferVectorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef BufferVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) BufferVectorResult put(@Const @ByRef BufferVectorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef BufferVectorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef BufferVector ValueOrDie();
  public native @ByRef @Name("operator *") BufferVector multiply();
  
  ///
  ///
  public native @Name("operator ->") BufferVector access();
  ...
  public native @Const @ByRef BufferVector ValueUnsafe();

  

  public native @ByVal BufferVector MoveValueUnsafe();
}
