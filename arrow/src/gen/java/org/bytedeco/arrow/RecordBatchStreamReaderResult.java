...
@Name("arrow::Result<std::shared_ptr<arrow::ipc::RecordBatchStreamReader> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class RecordBatchStreamReaderResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public RecordBatchStreamReaderResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public RecordBatchStreamReaderResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public RecordBatchStreamReaderResult position(long position) {
    ...
    @Override public RecordBatchStreamReaderResult getPointer(long i) {
        return new RecordBatchStreamReaderResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public RecordBatchStreamReaderResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public RecordBatchStreamReaderResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public RecordBatchStreamReaderResult(@SharedPtr RecordBatchStreamReader value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr RecordBatchStreamReader value);
  ...
  ///
  ///
  public RecordBatchStreamReaderResult(@Const @ByRef RecordBatchStreamReaderResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef RecordBatchStreamReaderResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) RecordBatchStreamReaderResult put(@Const @ByRef RecordBatchStreamReaderResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef RecordBatchStreamReaderResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr RecordBatchStreamReader ValueOrDie();
  public native @SharedPtr @Name("operator *") RecordBatchStreamReader multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") RecordBatchStreamReader access();
  ...
  public native @SharedPtr RecordBatchStreamReader MoveValueUnsafe();
}
