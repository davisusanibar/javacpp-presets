...
@Name("arrow::Result<std::shared_ptr<arrow::Table> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class TableResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TableResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public TableResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public TableResult getPointer(long i) {
        return new TableResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public TableResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public TableResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public TableResult(@SharedPtr @Cast({"", "std::shared_ptr<arrow::Table>"}) Table value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::Table>"}) Table value);
  ...
  ///
  ///
  public TableResult(@Const @ByRef TableResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef TableResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) TableResult put(@Const @ByRef TableResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef TableResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef Table ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") Table multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") Table access();
  ...
  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::Table>"}) Table ValueUnsafe();

  

  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::Table>"}) Table MoveValueUnsafe();
}
