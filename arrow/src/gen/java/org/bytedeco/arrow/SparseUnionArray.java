...
public class SparseUnionArray extends UnionArray {
   ...
   * 
   *  @param index [in] Which child array to get (i.e. the physical index, not the type
   *  code) @param pool [in] The pool to allocate null bitmaps from, if necessary */
  public native @ByVal ArrayResult GetFlattenedField(
        int index, MemoryPool pool/*=arrow::default_memory_pool()*/);
  public native @ByVal ArrayResult GetFlattenedField(
        int index);
}
