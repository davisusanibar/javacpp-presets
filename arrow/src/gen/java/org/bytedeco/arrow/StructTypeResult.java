...
@Name("arrow::Result<std::shared_ptr<arrow::StructType> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class StructTypeResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public StructTypeResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public StructTypeResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public StructTypeResult position(long position) {
        return (StructTypeResult)super.position(position);
    }
    @Override public StructTypeResult getPointer(long i) {
        return new StructTypeResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public StructTypeResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public StructTypeResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public StructTypeResult(@SharedPtr StructType value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr StructType value);
  ...
  ///
  ///
  public StructTypeResult(@Const @ByRef StructTypeResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef StructTypeResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) StructTypeResult put(@Const @ByRef StructTypeResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef StructTypeResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr StructType ValueOrDie();
  public native @SharedPtr @Name("operator *") StructType multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") StructType access();
  ...
  public native @SharedPtr StructType ValueUnsafe();

  

  public native @SharedPtr StructType MoveValueUnsafe();
}
