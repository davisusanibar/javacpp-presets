...
@Name("arrow::Result<arrow::compute::ExecBatch>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class ExecBatchResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ExecBatchResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ExecBatchResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ExecBatchResult position(long position) {
        return (ExecBatchResult)super.position(position);
    }
    @Override public ExecBatchResult getPointer(long i) {
        return new ExecBatchResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public ExecBatchResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ExecBatchResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) ExecBatch value);
  ...
  ///
  ///
  public ExecBatchResult(@Const @ByRef ExecBatchResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef ExecBatchResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) ExecBatchResult put(@Const @ByRef ExecBatchResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef ExecBatch ValueOrDie();
  public native @ByRef @Name("operator *") ExecBatch multiply();
  
  ///
  ///
  public native @Name("operator ->") ExecBatch access();
  ...
  public native @Const @ByRef ExecBatch ValueUnsafe();

  

  public native @ByVal ExecBatch MoveValueUnsafe();
}
