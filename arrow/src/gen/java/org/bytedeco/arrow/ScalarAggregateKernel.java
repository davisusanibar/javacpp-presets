...
public class ScalarAggregateKernel extends Kernel {
  ...
  public ScalarAggregateKernel(@SharedPtr @Cast({"", "std::shared_ptr<arrow::compute::KernelSignature>"}) KernelSignature sig, @ByVal @Cast("arrow::compute::KernelInit*") Pointer init,
                          ...
                          ScalarAggregateFinalize _finalize) { super((Pointer)null); allocate(sig, init, consume, merge, _finalize); }
  private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::compute::KernelSignature>"}) KernelSignature sig, @ByVal @Cast("arrow::compute::KernelInit*") Pointer init,
                          ScalarAggregateConsume consume, ScalarAggregateMerge merge,
                          ScalarAggregateFinalize _finalize);

  public ScalarAggregateKernel(@StdVector InputType in_types, @ByVal OutputType out_type,
                          @ByVal @Cast("arrow::compute::KernelInit*") Pointer init, ScalarAggregateConsume consume,
                          ScalarAggregateMerge merge, ScalarAggregateFinalize _finalize) { super((Pointer)null); allocate(in_types, out_type, init, consume, merge, _finalize); }
  private native void allocate(@StdVector InputType in_types, @ByVal OutputType out_type,
                          @ByVal @Cast("arrow::compute::KernelInit*") Pointer init, ScalarAggregateConsume consume,
                          ScalarAggregateMerge merge, ScalarAggregateFinalize _finalize);
  ...
  public native ScalarAggregateConsume consume(); public native ScalarAggregateKernel consume(ScalarAggregateConsume setter);
  public native ScalarAggregateMerge merge(); public native ScalarAggregateKernel merge(ScalarAggregateMerge setter);
  public native @Name("finalize") ScalarAggregateFinalize _finalize(); public native ScalarAggregateKernel _finalize(ScalarAggregateFinalize setter);
}
