...
@Name("arrow::Result<std::unique_ptr<arrow::Buffer> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class BufferUniqueResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public BufferUniqueResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public BufferUniqueResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public BufferUniqueResult position(long position) {
        return (BufferUniqueResult)super.position(position);
    }
    @Override public BufferUniqueResult getPointer(long i) {
        return new BufferUniqueResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public BufferUniqueResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public BufferUniqueResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public BufferUniqueResult(@UniquePtr ArrowBuffer value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@UniquePtr ArrowBuffer value);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef BufferUniqueResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @UniquePtr ArrowBuffer ValueOrDie();
  public native @UniquePtr @Name("operator *") ArrowBuffer multiply();
  
  ///
  ///
  public native @UniquePtr @Name("operator ->") ArrowBuffer access();
  ...
  public native @UniquePtr ArrowBuffer MoveValueUnsafe();
}
