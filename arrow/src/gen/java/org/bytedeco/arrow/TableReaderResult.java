...
@Name("arrow::Result<std::shared_ptr<arrow::csv::TableReader> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class TableReaderResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TableReaderResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public TableReaderResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public TableReaderResult getPointer(long i) {
        return new TableReaderResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public TableReaderResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public TableReaderResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public TableReaderResult(@SharedPtr TableReader value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr TableReader value);
  ...
  ///
  ///
  public TableReaderResult(@Const @ByRef TableReaderResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef TableReaderResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) TableReaderResult put(@Const @ByRef TableReaderResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef TableReaderResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr TableReader ValueOrDie();
  public native @SharedPtr @Name("operator *") TableReader multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") TableReader access();
  ...
  public native @SharedPtr TableReader MoveValueUnsafe();
}
