...
public class BufferBuilder extends Pointer {
    ...
    @Override public BufferBuilder getPointer(long i) {
        return new BufferBuilder((Pointer)this).offsetAddress(i);
    }

  public BufferBuilder(MemoryPool pool/*=default_memory_pool()*/,
                           @Cast("int64_t") long alignment/*=kDefaultBufferAlignment*/) { super((Pointer)null); allocate(pool, alignment); }
  private native void allocate(MemoryPool pool/*=default_memory_pool()*/,
                           @Cast("int64_t") long alignment/*=kDefaultBufferAlignment*/);
  ...
  public BufferBuilder(@SharedPtr @ByVal ResizableBuffer buffer,
                           ...
                           @Cast("int64_t") long alignment/*=kDefaultBufferAlignment*/) { super((Pointer)null); allocate(buffer, pool, alignment); }
