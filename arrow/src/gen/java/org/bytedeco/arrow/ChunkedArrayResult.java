...
@Name("arrow::Result<std::shared_ptr<arrow::ChunkedArray> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class ChunkedArrayResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ChunkedArrayResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ChunkedArrayResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ChunkedArrayResult position(long position) {
        return (ChunkedArrayResult)super.position(position);
    }
    @Override public ChunkedArrayResult getPointer(long i) {
        return new ChunkedArrayResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public ChunkedArrayResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ChunkedArrayResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public ChunkedArrayResult(@SharedPtr @Cast({"", "std::shared_ptr<arrow::ChunkedArray>"}) ChunkedArray value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::ChunkedArray>"}) ChunkedArray value);
  ...
  ///
  ///
  public ChunkedArrayResult(@Const @ByRef ChunkedArrayResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef ChunkedArrayResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) ChunkedArrayResult put(@Const @ByRef ChunkedArrayResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef ChunkedArrayResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef ChunkedArray ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") ChunkedArray multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") ChunkedArray access();
  ...
  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::ChunkedArray>"}) ChunkedArray ValueUnsafe();

  

  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::ChunkedArray>"}) ChunkedArray MoveValueUnsafe();
}
