...
@Name("arrow::Future<std::shared_ptr<arrow::csv::StreamingReader> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class StreamingReaderFuture extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public StreamingReaderFuture(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public StreamingReaderFuture(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public StreamingReaderFuture position(long position) {
        return (StreamingReaderFuture)super.position(position);
    }
    @Override public StreamingReaderFuture getPointer(long i) {
        return new StreamingReaderFuture((Pointer)this).offsetAddress(i);
    }
  ...
  public StreamingReaderFuture() { super((Pointer)null); allocate(); }
...
// #endif
  ...
  ///
  public native @Const @ByRef StreamingReaderResult result();
  ...
  public native @ByRef(true) StreamingReaderResult MoveResult();
  ...
  public native void MarkFinished(@ByVal StreamingReaderResult res);
  ...
  public static native @ByVal StreamingReaderFuture Make();

  /** \brief Producer API: instantiate a finished Future */
  public static native @ByVal StreamingReaderFuture MakeFinished(@ByVal StreamingReaderResult res);
  ...
  public StreamingReaderFuture(@SharedPtr @Cast({"", "std::shared_ptr<arrow::csv::StreamingReader>"}) StreamingReader val) { super((Pointer)null); allocate(val); }
  private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::csv::StreamingReader>"}) StreamingReader val);

  /** \brief Implicit constructor to create a future from a Result, enabling use
   *      of macros like ARROW_ASSIGN_OR_RAISE. */
  public StreamingReaderFuture(@ByVal StreamingReaderResult res) { super((Pointer)null); allocate(res); }
  private native void allocate(@ByVal StreamingReaderResult res);

  /** \brief Implicit constructor to create a future from a Status, enabling use
   *      of macros like ARROW_RETURN_NOT_OK. */
  public StreamingReaderFuture(@ByVal Status s) { super((Pointer)null); allocate(s); }
