...
public class Table extends Pointer {
   ...
   * 
   *  @param schema [in] the schema of the empty Table
   *  @param pool [in] the memory pool to allocate memory from
   *  @return the resulting Table */
  
  ///
  public static native @ByVal TableResult MakeEmpty(
  ...
  public native @Const @ByRef ChunkedArrayVector columns();
   ...
   * 
   *  @param pool [in] The pool for buffer allocations */
  public native @ByVal RecordBatchResult CombineChunksToBatch(
        MemoryPool pool/*=arrow::default_memory_pool()*/);
  public native @ByVal RecordBatchResult CombineChunksToBatch();
}
