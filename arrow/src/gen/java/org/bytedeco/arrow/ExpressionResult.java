...
@Name("arrow::Result<arrow::compute::Expression>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class ExpressionResult extends Pointer {
  ...
  @NoException(true) private native void allocate(@Const @ByRef ExpressionResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) ExpressionResult put(@Const @ByRef ExpressionResult other);
  ...
  public native @Const @ByRef Expression ValueUnsafe();
