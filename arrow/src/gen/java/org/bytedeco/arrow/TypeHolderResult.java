...
@Name("arrow::Result<arrow::TypeHolder>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class TypeHolderResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TypeHolderResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public TypeHolderResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public TypeHolderResult position(long position) {
        return (TypeHolderResult)super.position(position);
    }
    @Override public TypeHolderResult getPointer(long i) {
        return new TypeHolderResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public TypeHolderResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public TypeHolderResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public TypeHolderResult(@ByRef(true) TypeHolder value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@ByRef(true) TypeHolder value);
  ...
  ///
  ///
  public TypeHolderResult(@Const @ByRef TypeHolderResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef TypeHolderResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) TypeHolderResult put(@Const @ByRef TypeHolderResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef TypeHolderResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef TypeHolder ValueOrDie();
  public native @ByRef @Name("operator *") TypeHolder multiply();
  
  ///
  ///
  public native @Name("operator ->") TypeHolder access();
  ...
  public native @Const @ByRef TypeHolder ValueUnsafe();

  

  public native @ByVal TypeHolder MoveValueUnsafe();
}
