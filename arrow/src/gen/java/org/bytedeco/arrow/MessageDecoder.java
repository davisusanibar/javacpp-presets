...
public class MessageDecoder extends Pointer {
   ...
   *  @param skip_body [in] if true the body will be skipped even if the message has a body
   *  CPU, if required */
  ...
  public MessageDecoder(@SharedPtr MessageDecoderListener listener,
                            ...
                            @Cast("bool") boolean skip_body/*=false*/) { super((Pointer)null); allocate(listener, pool, skip_body); }
  private native void allocate(@SharedPtr MessageDecoderListener listener,
                            MemoryPool pool/*=arrow::default_memory_pool()*/,
                            @Cast("bool") boolean skip_body/*=false*/);
  ...
  public MessageDecoder(@SharedPtr MessageDecoderListener listener, State initial_state,
                   ...
                   MemoryPool pool/*=arrow::default_memory_pool()*/, @Cast("bool") boolean skip_body/*=false*/) { super((Pointer)null); allocate(listener, initial_state, initial_next_required_size, pool, skip_body); }
  private native void allocate(@SharedPtr MessageDecoderListener listener, State initial_state,
                   @Cast("int64_t") long initial_next_required_size,
                   MemoryPool pool/*=arrow::default_memory_pool()*/, @Cast("bool") boolean skip_body/*=false*/);
  public MessageDecoder(@SharedPtr MessageDecoderListener listener, State initial_state,
