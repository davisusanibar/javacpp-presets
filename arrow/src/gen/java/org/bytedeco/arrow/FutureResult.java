...
@Name("arrow::Result<arrow::Future<> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class FutureResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FutureResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FutureResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public FutureResult position(long position) {
        return (FutureResult)super.position(position);
    }
    @Override public FutureResult getPointer(long i) {
        return new FutureResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public FutureResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public FutureResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public FutureResult(@ByRef(true) Future value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@ByRef(true) Future value);
  ...
  ///
  ///
  public FutureResult(@Const @ByRef FutureResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef FutureResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) FutureResult put(@Const @ByRef FutureResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef FutureResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef Future ValueOrDie();
  public native @ByRef @Name("operator *") Future multiply();
  
  ///
  ///
  public native @Name("operator ->") Future access();
  ...
  public native @Const @ByRef Future ValueUnsafe();

  

  public native @ByVal Future MoveValueUnsafe();
}
