...
public class ScalarVisitor extends Pointer {
  ...
  public native @ByVal Status Visit(@Const @ByRef SparseUnionScalar scalar);
  public native @ByVal Status Visit(@Const @ByRef DenseUnionScalar scalar);
  public native @ByVal Status Visit(@Const @ByRef ExtensionScalar scalar);
}
