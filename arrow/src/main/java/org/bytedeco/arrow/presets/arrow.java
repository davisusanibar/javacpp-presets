...
public class arrow implements InfoMapper {
  ...
  public void map(InfoMap infoMap) {
    infoMap.put(new Info().enumerate().javaText("import org.bytedeco.arrow.Function;"))
        ...
        .put(new Info("basic/containers").cppTypes("std::optional", "std::function"))

        .put(new Info("arrow::internal::BitsetStack::reference").pointerTypes("BoolPointer"))
        .put(new Info("arrow::util::bytes_view", "arrow::internal::Bitmap", "std::atomic<int64_t>", "std::initializer_list").skip())
...
//               .put(new Info("arrow::Result<std::shared_ptr<arrow::fs::S3FileSystem> >").pointerTypes("S3FileSystemResult").define())
        ...
        .put(new Info("arrow::Result<std::shared_ptr<arrow::ipc::RecordBatchReader> >", "arrow::Result<std::shared_ptr<arrow::RecordBatchReader> >", "arrow::Result<std::shared_ptr<RecordBatchReader> >").pointerTypes("RecordBatchReaderSharedResult").define())
...
//                             "arrow::util::EqualityComparable<arrow::Result<arrow::util::string_view> >", // util fue eliminado
...
//                             "arrow::util::EqualityComparable<arrow::Result<std::vector<arrow::fs::FileStats> > >",
        ...
        // initial skip values
        .put(new Info(
            // skip to be able to create: arrow/target/native/org/bytedeco/substraitcpp/macosx-x86_64/jnijavacpp.cpp
            "arrow::BasicDecimal128",
            "arrow::Decimal128Scalar",
            "arrow::Decimal256Scalar",
            "arrow::MonthDayNanoIntervalArray::begin()",
            "arrow::MonthDayNanoIntervalArray::end()",
            "arrow::DayTimeIntervalArray::begin()",
            "arrow::DayTimeIntervalArray::end()",
            "arrow::GenericBasicDecimal<arrow::BasicDecimal256,256>::LittleEndianArrayTag",
            "std::array<uint8_t,arrow::GenericBasicDecimal<arrow::BasicDecimal256,256>::kByteWidth>",
            "std::array<uint8_t,arrow::GenericBasicDecimal<arrow::BasicDecimal128,128>::kByteWidth>",
            "arrow::GenericBasicDecimal<arrow::BasicDecimal128,128>::LittleEndianArrayTag",
            "arrow::Future<std::shared_ptr<arrow::Buffer> >::WrapResultyOnComplete",
            "arrow::Future<std::shared_ptr<arrow::Buffer> >::WrapStatusyOnComplete",
            "arrow::Future<std::shared_ptr<arrow::Buffer> >::ThenOnComplete",
            "arrow::Future<std::shared_ptr<arrow::Buffer> >::PassthruOnFailure",
            "arrow::TypeHolder::operator ==",
            // skip after creation of jnijavacpp.cpp
            "arrow::EqualOptions::signed_zeros_equal",
            "arrow::compute::HashAggregateKernel"
        ).skip())
        // FIXME! How to map: std::string_view
        .put(new Info("std::string_view").pointerTypes("@StdString String").define())
        .put(new Info("arrow::Result<std::string_view>").pointerTypes("StringViewResult").define())
        // new definitions
        .put(new Info("ARROW_DLLEXPORT", "ARROW_DLLIMPORT", "ARROW_ENGINE_EXPORT").cppTypes().annotations())
        .put(new Info("arrow::GenericBasicDecimal<arrow::BasicDecimal256,256>", "arrow::GenericBasicDecimal<BasicDecimal256,256>").pointerTypes("BasicDecimal256256GenericBasicDecimal").define())
        .put(new Info("std::variant<arrow::ArraySpan,std::shared_ptr<arrow::ArrayData> >").pointerTypes("ArraySpanArrayDataMap").define())
        .put(new Info("arrow::Result<arrow::TypeHolder>").pointerTypes("TypeHolderResult").define())
        .put(new Info("arrow::Result<arrow::TimestampScalar>").pointerTypes("TimestampScalarResult").define())
        .put(new Info("arrow::Result<arrow::RecordBatchWithMetadata>").pointerTypes("RecordBatchWithMetadataResult").define())
        .put(new Info("arrow::Future<std::shared_ptr<arrow::Buffer> >").pointerTypes("BufferFuture").define())
        .put(new Info("arrow::Result<std::unique_ptr<arrow::ArrayBuilder> >").pointerTypes("ArrayBuilderUniqueResult").define())
        .put(new Info("arrow::Result<std::shared_ptr<arrow::compute::FunctionExecutor> >").pointerTypes("FunctionExecutorResult").define())
        .put(new Info("arrow::Result<std::shared_ptr<arrow::StructType> >").pointerTypes("StructTypeResult").define())
        .put(new Info("arrow::Result<std::unique_ptr<arrow::RecordBatchBuilder> >").pointerTypes("RecordBatchBuilderUniqueResult").define())
        .put(new Info("arrow::Result<arrow::Future<> >").pointerTypes("FutureResult").define())
        .put(new Info("std::function<void(const char*)>").pointerTypes("Writer"))
        .put(new Info(
            "std::enable_shared_from_this<arrow::DataType>",
            "arrow::util::EqualityComparable<arrow::DataType>",
            "arrow::util::EqualityComparable<arrow::Field>",
            "arrow::util::EqualityComparable<arrow::FieldRef>",
            "std::enable_shared_from_this<arrow::Scalar>",
            "arrow::util::EqualityComparable<arrow::Result<arrow::RecordBatchWithMetadata> >",
            "arrow::util::EqualityComparable<arrow::Result<arrow::TypeHolder> >",
            "arrow::util::EqualityComparable<arrow::Result<std::unique_ptr<arrow::RecordBatchBuilder> > >",
            "arrow::util::EqualityComparable<arrow::Result<std::unique_ptr<arrow::ArrayBuilder> > >",
            "arrow::util::EqualityComparable<arrow::Result<std::shared_ptr<arrow::compute::FunctionExecutor> > >",
            "arrow::util::EqualityComparable<arrow::Result<std::shared_ptr<arrow::StructType> > >",
            "arrow::util::EqualityComparable<arrow::Result<arrow::Future<> > >",
            "arrow::util::EqualityComparable<arrow::Result<arrow::TimestampScalar> >",
            "arrow::util::EqualityComparable<arrow::Result<std::string_view> >"
