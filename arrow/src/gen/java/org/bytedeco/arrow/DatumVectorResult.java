...
@Name("arrow::Result<std::vector<arrow::Datum> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class DatumVectorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public DatumVectorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public DatumVectorResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public DatumVectorResult position(long position) {
        return (DatumVectorResult)super.position(position);
    }
    @Override public DatumVectorResult getPointer(long i) {
        return new DatumVectorResult((Pointer)this).offsetAddress(i);
    }
  ...
  ///
  ///
  public DatumVectorResult(@ByRef(true) DatumVector value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@ByRef(true) DatumVector value);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef DatumVectorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef DatumVector ValueOrDie();
  public native @ByRef @Name("operator *") DatumVector multiply();
  
  ///
  ///
  public native @Name("operator ->") DatumVector access();
  ...
  public native @ByVal DatumVector MoveValueUnsafe();
}
