...
public class ArrowBuffer extends Pointer {
  ...
  public ArrowBuffer(@ByVal @StdString String data) { super((Pointer)null); allocate(data); }
  private native void allocate(@ByVal @StdString String data);
  ...
  public native @ByVal @Name("operator std::string_view") @StdString String asString();
  ...
  ///
  ///
  public static native @ByVal BufferUniqueResult CopyNonOwned(
        @Const @ByRef ArrowBuffer source, @SharedPtr MemoryManager to);
