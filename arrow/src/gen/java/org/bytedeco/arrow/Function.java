...
public class Function extends Pointer {
  ...
  ///
  public native @ByVal @Cast("arrow::Result<const arrow::compute::Kernel*>*") KernelResult DispatchExact(@StdVector TypeHolder types);

  /** \brief Return a best-match kernel that can execute the function given the argument
   *  types, after implicit casts are applied.
   * 
   *  @param values [in,out] Argument types. An element may be modified to
  ...
  ///
  public native @ByVal @Cast("arrow::Result<const arrow::compute::Kernel*>*") KernelResult DispatchBest(@StdVector TypeHolder values);
   ...
   *  and KernelContext. If you want to change that, call {@code FunctionExecutor::Init}. */
  
  ///
  ///
  public native @ByVal FunctionExecutorResult GetBestExecutor(
        @StdVector TypeHolder inputs);
  ...
  ///
  public native @ByVal DatumResult Execute(@Const @ByRef ExecBatch batch, @Const FunctionOptions options,
                                  ExecContext ctx);
