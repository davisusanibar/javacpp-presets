...
@Name("arrow::Result<std::shared_ptr<arrow::io::CompressedInputStream> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class CompressedInputStreamResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public CompressedInputStreamResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public CompressedInputStreamResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public CompressedInputStreamResult getPointer(long i) {
        return new CompressedInputStreamResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public CompressedInputStreamResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public CompressedInputStreamResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public CompressedInputStreamResult(@SharedPtr CompressedInputStream value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr CompressedInputStream value);
  ...
  ///
  ///
  public CompressedInputStreamResult(@Const @ByRef CompressedInputStreamResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef CompressedInputStreamResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) CompressedInputStreamResult put(@Const @ByRef CompressedInputStreamResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef CompressedInputStreamResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr CompressedInputStream ValueOrDie();
  public native @SharedPtr @Name("operator *") CompressedInputStream multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") CompressedInputStream access();
  ...
  public native @SharedPtr CompressedInputStream ValueUnsafe();

  

  public native @SharedPtr CompressedInputStream MoveValueUnsafe();
}
