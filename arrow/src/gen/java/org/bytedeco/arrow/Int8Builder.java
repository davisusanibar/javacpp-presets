...
public class Int8Builder extends ArrayBuilder {
  ...
  public Int8Builder(@SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType type, MemoryPool pool,
   ...
   *  @return Status */
  public native @ByVal Status AppendValues(@Cast("const arrow::NumericBuilder<arrow::Int8Type>::value_type*") BytePointer values, @Cast("int64_t") long length, @Cast("const uint8_t*") BytePointer bitmap,
                        @Cast("int64_t") long bitmap_offset);
  public native @ByVal Status AppendValues(@Cast("const arrow::NumericBuilder<arrow::Int8Type>::value_type*") ByteBuffer values, @Cast("int64_t") long length, @Cast("const uint8_t*") ByteBuffer bitmap,
                        @Cast("int64_t") long bitmap_offset);
  public native @ByVal Status AppendValues(@Cast("const arrow::NumericBuilder<arrow::Int8Type>::value_type*") byte[] values, @Cast("int64_t") long length, @Cast("const uint8_t*") byte[] bitmap,
                        @Cast("int64_t") long bitmap_offset);
