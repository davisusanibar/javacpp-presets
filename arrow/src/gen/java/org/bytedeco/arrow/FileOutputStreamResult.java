...
@Name("arrow::Result<std::shared_ptr<arrow::io::FileOutputStream> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class FileOutputStreamResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FileOutputStreamResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FileOutputStreamResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public FileOutputStreamResult position(long position) {
        return (FileOutputStreamResult)super.position(position);
    }
    @Override public FileOutputStreamResult getPointer(long i) {
        return new FileOutputStreamResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public FileOutputStreamResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public FileOutputStreamResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public FileOutputStreamResult(@SharedPtr FileOutputStream value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr FileOutputStream value);
  ...
  ///
  ///
  public FileOutputStreamResult(@Const @ByRef FileOutputStreamResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef FileOutputStreamResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) FileOutputStreamResult put(@Const @ByRef FileOutputStreamResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef FileOutputStreamResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef @Cast({"", "std::shared_ptr<arrow::io::FileOutputStream>*"}) FileOutputStream ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") @Cast({"", "std::shared_ptr<arrow::io::FileOutputStream>*"}) FileOutputStream multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") @Cast({"", "std::shared_ptr<arrow::io::FileOutputStream>*"}) FileOutputStream access();
  ...
  public native @SharedPtr FileOutputStream ValueUnsafe();

  

  public native @SharedPtr FileOutputStream MoveValueUnsafe();
}
