...
@Name("arrow::Result<arrow::fs::FileInfo>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class FileInfoResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FileInfoResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FileInfoResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public FileInfoResult position(long position) {
        return (FileInfoResult)super.position(position);
    }
    @Override public FileInfoResult getPointer(long i) {
        return new FileInfoResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public FileInfoResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public FileInfoResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public FileInfoResult(@ByRef(true) FileInfo value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@ByRef(true) FileInfo value);
  ...
  ///
  ///
  public FileInfoResult(@Const @ByRef FileInfoResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef FileInfoResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) FileInfoResult put(@Const @ByRef FileInfoResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef FileInfoResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef FileInfo ValueOrDie();
  public native @ByRef @Name("operator *") FileInfo multiply();
  
  ///
  ///
  public native @Name("operator ->") FileInfo access();
  ...
  public native @Const @ByRef FileInfo ValueUnsafe();

  

  public native @ByVal FileInfo MoveValueUnsafe();
}
