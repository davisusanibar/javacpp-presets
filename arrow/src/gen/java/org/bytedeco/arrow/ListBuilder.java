...
public class ListBuilder extends BaseListBuilder {
    ...
    public ListBuilder(MemoryPool pool, @Const @SharedPtr @ByRef ArrayBuilder value_builder,
                      ...
                      @Cast("int64_t") long alignment/*=arrow::kDefaultBufferAlignment*/) { super((Pointer)null); allocate(pool, value_builder, type, alignment); }
    ...
    public ListBuilder(MemoryPool pool, @Const @SharedPtr @ByRef ArrayBuilder value_builder,
                      @Cast("int64_t") long alignment/*=arrow::kDefaultBufferAlignment*/) { super((Pointer)null); allocate(pool, value_builder, alignment); }
    private native void allocate(MemoryPool pool, @Const @SharedPtr @ByRef ArrayBuilder value_builder,
                      @Cast("int64_t") long alignment/*=arrow::kDefaultBufferAlignment*/);
