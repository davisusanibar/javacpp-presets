...
public class Status extends Pointer {
  ...
  // AND the statuses.
  public native @ByVal @Name("operator &") @NoException(true) Status and(@Const @ByRef Status s);
  public native @ByRef @Name("operator &=") @NoException(true) Status andPut(@Const @ByRef Status s);
  ...
  public native @Cast("const bool") boolean IsOutOfMemory();
  /** Return true iff the status indicates a key lookup error. */
  public native @Cast("const bool") boolean IsKeyError();
  /** Return true iff the status indicates invalid data. */
  public native @Cast("const bool") boolean IsInvalid();
  /** Return true iff the status indicates a cancelled operation. */
  public native @Cast("const bool") boolean IsCancelled();
  /** Return true iff the status indicates an IO-related failure. */
  public native @Cast("const bool") boolean IsIOError();
  /** Return true iff the status indicates a container reaching capacity limits. */
  public native @Cast("const bool") boolean IsCapacityError();
  /** Return true iff the status indicates an out of bounds index. */
  public native @Cast("const bool") boolean IsIndexError();
  /** Return true iff the status indicates a type error. */
  public native @Cast("const bool") boolean IsTypeError();
  /** Return true iff the status indicates an unknown error. */
  public native @Cast("const bool") boolean IsUnknownError();
  /** Return true iff the status indicates an unimplemented operation. */
  public native @Cast("const bool") boolean IsNotImplemented();
  /** Return true iff the status indicates a (de)serialization failure */
  public native @Cast("const bool") boolean IsSerializationError();
  /** Return true iff the status indicates a R-originated error. */
  public native @Cast("const bool") boolean IsRError();

  public native @Cast("const bool") boolean IsCodeGenError();

  public native @Cast("const bool") boolean IsExpressionValidationError();

  public native @Cast("const bool") boolean IsExecutionError();
  
  ///
  public native @Cast("const bool") boolean IsAlreadyExists();
  ...
  public native void Warn(@StdString String message);
  public native void Warn(@StdString BytePointer message);
