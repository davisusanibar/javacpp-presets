...
public class KernelContext extends Pointer {
  ...
  public KernelContext(ExecContext exec_ctx, @Const Kernel kernel/*=nullptr*/) { super((Pointer)null); allocate(exec_ctx, kernel); }
  private native void allocate(ExecContext exec_ctx, @Const Kernel kernel/*=nullptr*/);
  ...
  public native void SetKernel(@Const Kernel kernel);
  ...
  public native @Const Kernel kernel();
}
