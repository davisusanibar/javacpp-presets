...
public class VectorKernel extends Kernel {
  ...
  public static class ChunkedExec extends FunctionPointer {
      static { Loader.load(); }
      /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
      public    ChunkedExec(Pointer p) { super(p); }
      protected ChunkedExec() { allocate(); }
      private native void allocate();
      public native @ByVal Status call(KernelContext arg0, @Const @ByRef ExecBatch arg1, Datum out);
  }

  public VectorKernel() { super((Pointer)null); allocate(); }
  private native void allocate();

  public VectorKernel(@StdVector InputType in_types, @ByVal OutputType out_type, ArrayKernelExec exec,
                 @ByVal(nullValue = "arrow::compute::KernelInit(nullptr)") @Cast("arrow::compute::KernelInit*") Pointer init, @ByVal(nullValue = "arrow::compute::VectorKernel::FinalizeFunc(nullptr)") @Cast("arrow::compute::VectorKernel::FinalizeFunc*") Pointer _finalize) { super((Pointer)null); allocate(in_types, out_type, exec, init, _finalize); }
  private native void allocate(@StdVector InputType in_types, @ByVal OutputType out_type, ArrayKernelExec exec,
                 @ByVal(nullValue = "arrow::compute::KernelInit(nullptr)") @Cast("arrow::compute::KernelInit*") Pointer init, @ByVal(nullValue = "arrow::compute::VectorKernel::FinalizeFunc(nullptr)") @Cast("arrow::compute::VectorKernel::FinalizeFunc*") Pointer _finalize);
  public VectorKernel(@StdVector InputType in_types, @ByVal OutputType out_type, ArrayKernelExec exec) { super((Pointer)null); allocate(in_types, out_type, exec); }
  private native void allocate(@StdVector InputType in_types, @ByVal OutputType out_type, ArrayKernelExec exec);

  public VectorKernel(@SharedPtr @Cast({"", "std::shared_ptr<arrow::compute::KernelSignature>"}) KernelSignature sig, ArrayKernelExec exec,
                 @ByVal @Cast("arrow::compute::KernelInit*") Pointer init, @ByVal(nullValue = "arrow::compute::VectorKernel::FinalizeFunc(nullptr)") @Cast("arrow::compute::VectorKernel::FinalizeFunc*") Pointer _finalize) { super((Pointer)null); allocate(sig, exec, init, _finalize); }
  private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::compute::KernelSignature>"}) KernelSignature sig, ArrayKernelExec exec,
                 @ByVal @Cast("arrow::compute::KernelInit*") Pointer init, @ByVal(nullValue = "arrow::compute::VectorKernel::FinalizeFunc(nullptr)") @Cast("arrow::compute::VectorKernel::FinalizeFunc*") Pointer _finalize);
  public VectorKernel(@SharedPtr @Cast({"", "std::shared_ptr<arrow::compute::KernelSignature>"}) KernelSignature sig, ArrayKernelExec exec,
  ...
  public native ArrayKernelExec exec(); public native VectorKernel exec(ArrayKernelExec setter);

  /** \brief Execute the kernel on a ChunkedArray. Does not need to be defined */
  public native ChunkedExec exec_chunked(); public native VectorKernel exec_chunked(ChunkedExec setter);
  ...
  public native @ByRef @Cast("arrow::compute::VectorKernel::FinalizeFunc*") @Name("finalize") Pointer _finalize(); public native VectorKernel _finalize(Pointer setter);
   ...
   *  functionality. */
  public native @Cast("bool") boolean can_write_into_slices(); public native VectorKernel can_write_into_slices(boolean setter);
