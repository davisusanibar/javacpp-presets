...
@Name("arrow::Result<std::shared_ptr<arrow::internal::ThreadPool> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class ThreadPoolResult extends Pointer {
    ...
    @Override public ThreadPoolResult getPointer(long i) {
        return new ThreadPoolResult((Pointer)this).offsetAddress(i);
    }
  ...
  @NoException(true) private native void allocate(@SharedPtr @ByRef(true) ThreadPool value);
  ...
  @NoException(true) private native void allocate(@Const @ByRef ThreadPoolResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) ThreadPoolResult put(@Const @ByRef ThreadPoolResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef ThreadPool ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") ThreadPool multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") ThreadPool access();
  ...
  public native @Const @SharedPtr @ByRef ThreadPool ValueUnsafe();

  

  public native @SharedPtr @ByVal ThreadPool MoveValueUnsafe();
}
