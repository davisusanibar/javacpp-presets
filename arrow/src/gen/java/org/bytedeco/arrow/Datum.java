...
public class Datum extends Pointer {
  ...
  public enum Kind { NONE(0), SCALAR(1), ARRAY(2), CHUNKED_ARRAY(3), RECORD_BATCH(4), TABLE(5);
  ...
  public native @Cast("int64_t") long TotalBufferSize();
  ...
  public native @Cast("bool") boolean is_chunked_array();
