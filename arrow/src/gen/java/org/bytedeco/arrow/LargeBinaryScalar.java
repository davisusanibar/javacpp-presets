...
public class LargeBinaryScalar extends BaseBinaryScalar {
    ...
    @Override public LargeBinaryScalar getPointer(long i) {
        return new LargeBinaryScalar((Pointer)this).offsetAddress(i);
    }
  ...
  public LargeBinaryScalar(@StdString String s) { super((Pointer)null); allocate(s); }
  private native void allocate(@StdString String s);
  public LargeBinaryScalar(@StdString BytePointer s) { super((Pointer)null); allocate(s); }
