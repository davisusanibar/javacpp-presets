...
@Name("arrow::Result<std::unique_ptr<arrow::compute::FunctionOptions> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class FunctionOptionsResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FunctionOptionsResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FunctionOptionsResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public FunctionOptionsResult position(long position) {
        return (FunctionOptionsResult)super.position(position);
    }
    @Override public FunctionOptionsResult getPointer(long i) {
        return new FunctionOptionsResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public FunctionOptionsResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public FunctionOptionsResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public FunctionOptionsResult(@UniquePtr FunctionOptions value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@UniquePtr FunctionOptions value);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef FunctionOptionsResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @UniquePtr FunctionOptions ValueOrDie();
  public native @UniquePtr @Name("operator *") FunctionOptions multiply();
  
  ///
  ///
  public native @UniquePtr @Name("operator ->") FunctionOptions access();
  ...
  public native @UniquePtr FunctionOptions ValueUnsafe();

  

  public native @UniquePtr FunctionOptions MoveValueUnsafe();
}
