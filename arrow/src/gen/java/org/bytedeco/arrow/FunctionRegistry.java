...
public class FunctionRegistry extends Pointer {
  ...
  ///
  public static native @UniquePtr FunctionRegistry Make(FunctionRegistry parent);
  ...
  ///
  public native @ByVal Status CanAddFunction(@SharedPtr Function function, @Cast("bool") boolean allow_overwrite/*=false*/);
  public native @ByVal Status CanAddFunction(@SharedPtr Function function);
   ...
   * 
   *  @return Status::KeyError if the function with the given name is not registered. */
  
  ///
  public native @ByVal Status CanAddAlias(@StdString String target_name, @StdString String source_name);
  public native @ByVal Status CanAddAlias(@StdString BytePointer target_name, @StdString BytePointer source_name);
  ...
  ///
  public native @ByVal Status CanAddFunctionOptionsType(@Const FunctionOptionsType options_type,
