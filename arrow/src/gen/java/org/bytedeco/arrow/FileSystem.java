...
public class FileSystem extends Pointer {
  ...
  public native @ByVal Status DeleteDirContents(@StdString String path,
                                     @Cast("bool") boolean missing_dir_ok/*=false*/);
  public native @ByVal Status DeleteDirContents(@StdString String path);
  ...
  ///
  public native @ByVal Future DeleteDirContentsAsync(@StdString String path,
                                            @Cast("bool") boolean missing_dir_ok/*=false*/);
  public native @ByVal Future DeleteDirContentsAsync(@StdString String path);
  public native @ByVal Future DeleteDirContentsAsync(@StdString BytePointer path,
                                            @Cast("bool") boolean missing_dir_ok/*=false*/);
  public native @ByVal Future DeleteDirContentsAsync(@StdString BytePointer path);
