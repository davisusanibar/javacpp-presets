...
@Name("arrow::Result<std::shared_ptr<arrow::compute::FunctionExecutor> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class FunctionExecutorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FunctionExecutorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FunctionExecutorResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public FunctionExecutorResult position(long position) {
        return (FunctionExecutorResult)super.position(position);
    }
    @Override public FunctionExecutorResult getPointer(long i) {
        return new FunctionExecutorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public FunctionExecutorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public FunctionExecutorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public FunctionExecutorResult(@SharedPtr FunctionExecutor value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr FunctionExecutor value);
  ...
  ///
  ///
  public FunctionExecutorResult(@Const @ByRef FunctionExecutorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef FunctionExecutorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) FunctionExecutorResult put(@Const @ByRef FunctionExecutorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef FunctionExecutorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr FunctionExecutor ValueOrDie();
  public native @SharedPtr @Name("operator *") FunctionExecutor multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") FunctionExecutor access();
  ...
  public native @SharedPtr FunctionExecutor ValueUnsafe();

  

  public native @SharedPtr FunctionExecutor MoveValueUnsafe();
}
