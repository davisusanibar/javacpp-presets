...
@Name("arrow::Result<std::pair<arrow::Decimal256,arrow::Decimal256> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class Decimal256PairResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public Decimal256PairResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public Decimal256PairResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public Decimal256PairResult position(long position) {
        return (Decimal256PairResult)super.position(position);
    }
    @Override public Decimal256PairResult getPointer(long i) {
        return new Decimal256PairResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public Decimal256PairResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public Decimal256PairResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) Decimal256Pair value);
  ...
  ///
  ///
  public Decimal256PairResult(@Const @ByRef Decimal256PairResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef Decimal256PairResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) Decimal256PairResult put(@Const @ByRef Decimal256PairResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef Decimal256PairResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef Decimal256Pair ValueOrDie();
  public native @ByRef @Name("operator *") Decimal256Pair multiply();
  
  ///
  ///
  public native @Name("operator ->") Decimal256Pair access();
  ...
  public native @Const @ByRef Decimal256Pair ValueUnsafe();

  

  public native @ByVal Decimal256Pair MoveValueUnsafe();
}
