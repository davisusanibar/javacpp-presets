...
@Name("arrow::Result<std::vector<std::shared_ptr<arrow::Schema> > >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class SchemaVectorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public SchemaVectorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public SchemaVectorResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public SchemaVectorResult position(long position) {
        return (SchemaVectorResult)super.position(position);
    }
    @Override public SchemaVectorResult getPointer(long i) {
        return new SchemaVectorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public SchemaVectorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public SchemaVectorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) SchemaVector value);
  ...
  ///
  ///
  public SchemaVectorResult(@Const @ByRef SchemaVectorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef SchemaVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) SchemaVectorResult put(@Const @ByRef SchemaVectorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef SchemaVectorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef SchemaVector ValueOrDie();
  public native @ByRef @Name("operator *") SchemaVector multiply();
  
  ///
  ///
  public native @Name("operator ->") SchemaVector access();
  ...
  public native @Const @ByRef SchemaVector ValueUnsafe();

  

  public native @ByVal SchemaVector MoveValueUnsafe();
}
