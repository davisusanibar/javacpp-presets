...
@Name("arrow::Result<arrow::compute::ScalarKernel*>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class ScalarKernelResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ScalarKernelResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ScalarKernelResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ScalarKernelResult position(long position) {
        return (ScalarKernelResult)super.position(position);
    }
    @Override public ScalarKernelResult getPointer(long i) {
        return new ScalarKernelResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public ScalarKernelResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ScalarKernelResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public ScalarKernelResult(ScalarKernel value) { super((Pointer)null); allocate(value); }
  ...
  ///
  ///
  public ScalarKernelResult(@Cast("const arrow::Result<arrow::compute::ScalarKernel*>*") @ByRef ScalarKernelResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Cast("const arrow::Result<arrow::compute::ScalarKernel*>*") @ByRef ScalarKernelResult other);
  ...
  ///
  ///
  public native @Cast("arrow::Result<arrow::compute::ScalarKernel*>*") @ByRef @Name("operator =") @NoException(true) ScalarKernelResult put(@Cast("const arrow::Result<arrow::compute::ScalarKernel*>*") @ByRef ScalarKernelResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Cast("const arrow::Result<arrow::compute::ScalarKernel*>*") @ByRef ScalarKernelResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByPtrRef ScalarKernel ValueOrDie();
  public native @ByPtrRef @Name("operator *") ScalarKernel multiply();
  
  ///
  ///
  public native @Cast("arrow::compute::ScalarKernel**") @Name("operator ->") PointerPointer access();
  ...
  public native ScalarKernel MoveValueUnsafe();
}
