...
@Name("arrow::Result<arrow::TimestampScalar>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class TimestampScalarResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TimestampScalarResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public TimestampScalarResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public TimestampScalarResult position(long position) {
        return (TimestampScalarResult)super.position(position);
    }
    @Override public TimestampScalarResult getPointer(long i) {
        return new TimestampScalarResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public TimestampScalarResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public TimestampScalarResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public TimestampScalarResult(@ByRef(true) TimestampScalar value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@ByRef(true) TimestampScalar value);
  ...
  ///
  ///
  public TimestampScalarResult(@Const @ByRef TimestampScalarResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef TimestampScalarResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) TimestampScalarResult put(@Const @ByRef TimestampScalarResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef TimestampScalarResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef TimestampScalar ValueOrDie();
  public native @ByRef @Name("operator *") TimestampScalar multiply();
  
  ///
  ///
  public native @Name("operator ->") TimestampScalar access();
  ...
  public native @Const @ByRef TimestampScalar ValueUnsafe();

  

  public native @ByVal TimestampScalar MoveValueUnsafe();
}
