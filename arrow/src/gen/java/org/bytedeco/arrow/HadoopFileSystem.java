...
public class HadoopFileSystem extends IOFileSystem {
  ...
  public native @ByVal Status Copy(@StdString String src, @StdString String dst);
  public native @ByVal Status Copy(@StdString BytePointer src, @StdString BytePointer dst);

  public native @ByVal Status Move(@StdString String src, @StdString String dst);
  public native @ByVal Status Move(@StdString BytePointer src, @StdString BytePointer dst);
  ...
  public native @ByVal Status OpenReadable(@StdString String path, @Const @ByRef IOContext io_context,
                        @SharedPtr HdfsReadableFile file);
  public native @ByVal Status OpenReadable(@StdString BytePointer path, @Const @ByRef IOContext io_context,
                        @SharedPtr HdfsReadableFile file);
